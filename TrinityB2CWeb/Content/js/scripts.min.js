! function (e, t) {
    ...
    var p = function (n) {
        var e, p, _, r, o, h, u, m, w, l, c, k, C, s, x, g, a, d, v, T = "sizzle" + 1 * new Date,
            b = n.document,
            j = 0,
            i = 0,
            f = se(),
            ...
            if (!i && ((t ? t.ownerDocument || t : b) !== C && k(t), t = t || C, x)) {
                if (11 !== f && (l = G.exec(e)))
                    if (o = l[1]) {
                        ...
                        if ((o = l[3]) && p.getElementsByClassName && t.getElementsByClassName) return I.apply(n, t.getElementsByClassName(o)), n
                    } if (p.qsa && !E[e + " "] && (!g || !g.test(e))) {
                        if (1 !== f) u = t, d = e;
                        else if ("object" !== t.nodeName.toLowerCase()) {
                            for ((a = t.getAttribute("id")) ? a = a.replace(te, ne) : t.setAttribute("id", a = T), r = (c = h(e)).length; r--;) c[r] = "#" + a + " " + ve(c[r]);
        ...
        for (e in p = re.support = {}, o = re.isXML = function (e) {
                ...
                return i !== C && 9 === i.nodeType && i.documentElement && (s = (C = i).documentElement, x = !o(C), b !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ie, !1) : n.attachEvent && n.attachEvent("onunload", ie)), p.attributes = le(function (e) {
                    return e.className = "i", !e.getAttribute("className")
        }), p.getElementsByTagName = le(function (e) {
                    return e.appendChild(C.createComment("")), !e.getElementsByTagName("*").length
        }), p.getElementsByClassName = X.test(C.getElementsByClassName), p.getById = le(function (e) {
        ...
        }, a = [], g = [], (p.qsa = X.test(C.querySelectorAll)) && (le(function (e) {
        ...
        })), (p.matchesSelector = X.test(d = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector)) && le(function (e) {
                    p.disconnectedMatch = d.call(e, "*"), d.call(e, "[s!='']:x"), a.push("!=", M)
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !p.sortDetached && t.compareDocumentPosition(e) === n ? e === C || e.ownerDocument === b && v(b, e) ? -1 : t === C || t.ownerDocument === b && v(b, t) ? 1 : l ? q(l, e) - q(l, t) : 0 : 4 & n ? -1 : 1)
        } : function (e, t) {
                    if (e === t) return c = !0, 0;
                    var n, i = 0,
                        o = e.parentNode,
                ...
                if ((e.ownerDocument || e) !== C && k(e), t = t.replace(U, "='$1']"), p.matchesSelector && x && !E[t + " "] && (!a || !a.test(t)) && (!g || !g.test(t))) try {
                    var n = d.call(e, t);
                        ...
                        return 1 === m && 0 === g ? function (e) {
                            ...
                            if (d) {
                                ...
                                if (l = [b ? d.firstChild : d.lastChild], b && f) {
                                    for (p = (a = (i = (o = (r = (s = d)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] || [])[0] === j && i[1]) && i[2], s = a && d.childNodes[a]; s = ++a && s && s[c] || (p = a = 0) || l.pop() ;)
                                        if (1 === s.nodeType && ++p && s === e) {
                                            o[h] = [j, a, p];
                                            break
        }
        } else if (f && (p = a = (i = (o = (r = (s = e)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] || [])[0] === j && i[1]), !1 === p)
                                    for (;
                                        (s = ++a && s && s[c] || (p = a = 0) || l.pop()) && ((y ? s.nodeName.toLowerCase() !== u : 1 !== s.nodeType) || !++p || (f && ((o = (r = s[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] = [j, p]), s !== e)) ;);
        ...
        return ge.prototype = _.filters = _.pseudos, _.setFilters = new ge, h = re.tokenize = function (e, t) {
            ...
            var n, g, v, b, y, i, o = [],
                ...
                s = E[e + " "];
            if (!s) {
                for (t || (t = h(e)), n = t.length; n--;) (s = ke(t[n]))[T] ? o.push(s) : r.push(s);
                (s = E(e, (g = r, v = o, b = 0 < v.length, y = 0 < g.length, i = function (e, t, n, i, o) {
                    var r, s, a, l = 0,
                        ...
                        m = p.length;
                    for (o && (w = t === C || t || o) ; c !== m && null != (r = p[c]) ; c++) {
                        if (y && r) {
        ...
        }, p.sortStable = T.split("").sort(S).join("") === T, p.detectDuplicates = !!c, k(), p.sortDetached = le(function (e) {
    ...
    T.Deferred.exceptionHook = function (e, t) {
        C.console && C.console.warn && e && M.test(e.name) && C.console.warn("jQuery.Deferred exception: " + e.message, e.stack, t)
    ...
    T.fn.ready = function (e) {
        ...
        readyWait: 1,
        ready: function (e) {
            (!0 === e ? --T.readyWait : T.isReady) || ((T.isReady = !0) !== e && 0 < --T.readyWait || B.resolveWith(x, [T]))
        }
    }), T.ready.then = B.then, "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? C.setTimeout(T.ready) : (x.addEventListener("DOMContentLoaded", z), C.addEventListener("load", z));
    ...
    function ve(e, t, n, i, o) {
        ...
        for (u.textContent = "", p = 0; r = f[p++];)
            ...
            else if (c = T.contains(r.ownerDocument, r), s = fe(u.appendChild(r), "script"), c && pe(s), n)
                for (d = 0; r = s[d++];) de.test(r.type || "") && n.push(r);
        return u
    }
    he = x.createDocumentFragment().appendChild(x.createElement("div")), (me = x.createElement("input")).setAttribute("type", "radio"), me.setAttribute("checked", "checked"), me.setAttribute("name", "t"), he.appendChild(me), v.checkClone = he.cloneNode(!0).cloneNode(!0).lastChild.checked, he.innerHTML = "<textarea>x</textarea>", v.noCloneChecked = !!he.cloneNode(!0).lastChild.defaultValue;
    ...
    T.event = {
        ...
        add: function (t, e, n, i, o) {
            var r, s, a, l, c, d, u, f, p, h, m, g = V.get(t);
            if (g)
                for (n.handler && (n = (r = n).handler, o = r.selector), o && T.find.matchesSelector(be, o), n.guid || (n.guid = T.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (e) {
                ...
                }), c = (e = (e || "").match(P) || [""]).length; c--;) p = m = (a = we.exec(e[c]) || [])[1], h = (a[2] || "").split(".").sort(), p && (u = T.event.special[p] || {}, p = (o ? u.delegateType : u.bindType) || p, u = T.event.special[p] || {}, d = T.extend({
                    type: p,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, r), (f = l[p]) || ((f = l[p] = []).delegateCount = 0, u.setup && !1 !== u.setup.call(t, i, h, s) || t.addEventListener && t.addEventListener(p, s)), u.add && (u.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, d) : f.push(d), T.event.global[p] = !0)
        },
        remove: function (e, t, n, i, o) {
            var r, s, a, l, c, d, u, f, p, h, m, g = V.hasData(e) && V.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--;)
                    if (p = m = (a = we.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), p) {
                        for (u = T.event.special[p] || {}, f = l[p = (i ? u.delegateType : u.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = f.length; r--;) d = f[r], !o && m !== d.origType || n && n.guid !== d.guid || a && !a.test(d.namespace) || i && i !== d.selector && ("**" !== i || !d.selector) || (f.splice(r, 1), d.selector && f.delegateCount--, u.remove && u.remove.call(e, d));
                        s && !f.length && (u.teardown && !1 !== u.teardown.call(e, h, g.handle) || T.removeEvent(e, p, g.handle), delete l[p])
                    } else
    ...
    function qe(n, i, o, r) {
        ...
        var e, t, s, a, l, c, d = 0,
            ...
            p = i[0],
            h = b(p);
        if (h || 1 < u && "string" == typeof p && !v.checkClone && Se.test(p)) return n.each(function (e) {
            var t = n.eq(e);
            h && (i[0] = p.call(this, e, t.html())), qe(t, i, o, r)
        });
    ...
    function Pe(e, t, n) {
        for (var i, o = t ? T.filter(t, e) : e, r = 0; null != (i = o[r]) ; r++) n || 1 !== i.nodeType || T.cleanData(fe(i)), i.parentNode && (n && T.contains(i.ownerDocument, i) && pe(fe(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    T.extend({
    ...
    T.extend({
        ...
        css: function (e, t, n, i) {
            var o, r, s, a = K(t);
            return Re.test(t) || (t = Ye(a)), (s = T.cssHooks[t] || T.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Me(e, t, i)), "normal" === o && t in Ue && (o = Ue[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
        ...
        if (t) return (parseFloat(Me(e, "marginLeft")) || e.getBoundingClientRect().left - oe(e, {
            marginLeft: 0
        }, function () {
        ...
        prefilters: [function (e, t, n) {
            ...
            for (i in n.queue || (null == (s = T._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                ...
                if (o = t[i], nt.test(o)) {
                    ...
                    for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = V.get(e, "display")), "none" === (d = T.css(e, "display")) && (c ? d = c : (ae([e], !0), c = e.style.display || c, d = T.css(e, "display"), ae([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === T.css(e, "float") && (l || (f.done(function () {
                            h.display = c
                        ...
                        for (i in m || ae([e]), V.remove(e, "fxshow"), p) T.style(e, i, p[i])
    ...
    T.fn.extend({
        ...
        toggleClass: function (o, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(o) : this.removeClass(o) : b(o) ? this.each(function (e) {
                ...
                else void 0 !== o && "boolean" !== r || ((e = ht(this)) && V.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === o ? "" : V.get(this, "__className__") || ""))
            })
        },
        hasClass: function (e) {
            var t, n, i = 0;
    ...
    T.extend(T.event, {
        trigger: function (e, t, n, i) {
            ...
            if (r = u = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !vt.test(p + T.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, (e = e[T.expando] ? e : new T.Event(p, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : T.makeArray(t, [e]), d = T.event.special[p] || {}, i || !d.trigger || !1 !== d.trigger.apply(n, t))) {
                if (!i && !d.noBubble && !y(n)) {
                    for (a = d.delegateType || p, vt.test(a + p) || (r = r.parentNode) ; r; r = r.parentNode) f.push(r), s = r;
                    s === (n.ownerDocument || x) && f.push(s.defaultView || s.parentWindow || C)
                }
                for (o = 0;
                    (r = f[o++]) && !e.isPropagationStopped() ;) u = r, e.type = 1 < o ? a : d.bindType || p, (c = (V.get(r, "events") || {})[e.type] && V.get(r, "handle")) && c.apply(r, t), (c = l && r[l]) && c.apply && Y(r) && (e.result = c.apply(r, t), !1 === e.result && e.preventDefault());
                return e.type = p, i || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), t) || !Y(n) || l && b(n[p]) && !y(n) && ((s = n[l]) && (n[l] = null), T.event.triggered = p, e.isPropagationStopped() && u.addEventListener(p, bt), n[p](), e.isPropagationStopped() && u.removeEventListener(p, bt), T.event.triggered = void 0, s && (n[l] = s)), e.result
            }
        },
    ...
    Lt.href = yt.href, T.extend({
        ...
        ajax: function (e, t) {
            ...
            var d, u, f, n, p, i, h, m, o, r, g = T.ajaxSetup({}, t),
                v = g.context || g,
            ...
            if (g.data && g.processData && "string" != typeof g.data && (g.data = T.param(g.data, g.traditional)), Wt(Ot, g, t, k), h) return k;
            ...
            if (l = "abort", _.add(g.complete), k.done(g.success), k.fail(g.error), d = Wt(qt, g, t, k)) {
                if (k.readyState = 1, m && b.trigger("ajaxSend", [k, g]), h) return k;
            ...
            function c(e, t, n, i) {
                var o, r, s, a, l, c = t;
                h || (h = !0, p && C.clearTimeout(p), d = void 0, f = i || "", k.readyState = 0 < e ? 4 : 0, o = 200 <= e && e < 300 || 304 === e, n && (a = function (e, t, n) {
    ...
    v.cors = !!zt && "withCredentials" in zt, v.ajax = zt = !!zt, T.ajaxTransport(function (o) {
        ...
        if (v.cors || zt && !o.crossDomain) return {
            send: function (e, t) {
                ...
                r = function (e) {
                    return function () {
                        r && (r = s = i.onload = i.onerror = i.onabort = i.ontimeout = i.onreadystatechange = null, "abort" === e ? i.abort() : "error" === e ? "number" != typeof i.status ? t(0, "error") : t(i.status, i.statusText) : t(Bt[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                            binary: i.response
                        } : {
                            text: i.responseText
    ...
    T.ajaxSetup({
        ...
        var i, o, r, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = pt(e.slice(a)), e = e.slice(0, a)), b(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < s.length && T.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
...
function (e, t) {
    ...
    function f(e, t, n, i) {
        ...
        if ("viewport" === i) r = (o = f).ownerDocument.documentElement, s = E(o, r), a = H(r.clientWidth, window.innerWidth || 0), l = H(r.clientHeight, window.innerHeight || 0), c = C(r), d = C(r, "left"), u = T({
            ...
            var p;
            "scrollParent" === i ? "BODY" === (p = y(b(t))).nodeName && (p = e.ownerDocument.documentElement) : p = "window" === i ? e.ownerDocument.documentElement : i;
            var h = E(p, f);
    ...
    for (var P = Math.min, L = Math.floor, H = Math.max, m = "undefined" != typeof window && "undefined" != typeof document, g = ["Edge", "Trident", "Firefox"], v = 0, W = 0; W < g.length; W += 1)
        if (m && 0 <= navigator.userAgent.indexOf(g[W])) {
            v = 1;
            break
        } var M, B = m && window.Promise ? function (e) {
            var t = !1;
            return function () {
        ...
        X = function () {
            function r(e, t) {
                ...
                }, this.update = B(this.update.bind(this)), this.options = U({}, r.Defaults, i), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
            ...
            arrow: {
                ...
                fn: function (e, t) {
                    ...
                    var o = e.placement.split("-")[0],
                        ...
                        p = l ? "bottom" : "right",
                        h = S(i)[c];
                    a[p] - h < s[u] && (e.offsets.popper[u] -= s[u] - (a[p] - h)), a[u] + h > s[p] && (e.offsets.popper[u] += a[u] + h - s[p]), e.offsets.popper = T(e.offsets.popper);
                    var m = a[u] + a[c] / 2 - h / 2,
                        g = _(e.instance.popper),
                        v = parseFloat(g["margin" + d], 10),
                        b = parseFloat(g["border" + d + "Width"], 10),
                        y = m - e.offsets.popper[u] - v - b;
                    return y = H(P(s[c] - h, y), 0), e.arrowElement = i, e.offsets.arrow = (F(n = {}, u, Math.round(y)), F(n, f, ""), n), e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function (h, m) {
                    ...
                    var g = f(h.instance.popper, h.instance.reference, m.padding, m.boundariesElement),
                    ...
                    return _.forEach(function (e, t) {
                        ...
                        var n, i = h.offsets.popper,
                            ...
                            p = !!m.flipVariations && (f && "start" === y && a || f && "end" === y && l || !f && "start" === y && c || !f && "end" === y && d);
                        (s || u || p) && (h.flipped = !0, (s || u) && (v = _[t + 1]), p && (y = "end" === (n = y) ? "start" : "start" === n ? "end" : n), h.placement = v + (y ? "-" + y : ""), h.offsets.popper = U({}, h.offsets.popper, D(h.instance.popper, h.offsets.reference, h.placement)), h = I(h.instance.modifiers, h, "flip"))
                    }), h
                },
                behavior: "flip",
                padding: 5,
            ...
            computeStyle: {
                ...
                fn: function (e, t) {
                    ...
                    if (a = "bottom" == f ? -c.height + u.bottom : u.top, s = "right" == p ? -c.width + u.right : u.left, l && h) d[h] = "translate3d(" + s + "px, " + a + "px, 0)", d[f] = 0, d[p] = 0, d.willChange = "transform";
                        ...
                        var m = "bottom" == f ? -1 : 1,
                            g = "right" == p ? -1 : 1;
                        d[f] = a * m, d[p] = s * g, d.willChange = f + ", " + p
                    }
                    var v = {
...
function (e, t) {
    ...
    var o, n, r, a, c, u, f, p, h, m, g, v, b, y, _, w, k, C, x, T, j, E, S, A, D, N, I, O, q, P, L, H, W, M, B, z, R, F, U, Q, K, Y, $, V, X, G, J, Z, ee, te, ne, ie, oe, re, se, ae, le, ce, de, ue, fe, pe, he, me, ge, ve, be, ye, _e, we, ke, Ce, xe, Te, je, Ee, Se, Ae, De, Ne, Ie, Oe, qe, Pe, Le, He, We, Me, Be, ze, Re, Fe, Ue, Qe, Ke, Ye, $e, Ve, Xe, Ge, Je, Ze, et, tt, nt, it, ot, rt, st, at, lt, ct, dt, ut, ft, pt, ht, mt, gt, vt, bt, yt, _t, wt, kt, Ct, xt, Tt, jt, Et = (Tt = "transitionend", jt = {
        ...
        typeCheckConfig: function (e, t, n) {
            for (var i in n)
                if (Object.prototype.hasOwnProperty.call(n, i)) {
                    var o = n[i],
                        r = t[i],
                        s = r && jt.isElement(r) ? "element" : (a = r, {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase());
        ...
        var t = this,
            n = !1;
        return xt(this).one(jt.TRANSITION_END, function () {
            n = !0
        }), setTimeout(function () {
            n || jt.triggerTransitionEnd(t)
        }, e), this
    }, xt.event.special[jt.TRANSITION_END] = {
        bindType: Tt,
        delegateType: Tt,
        handle: function (e) {
        ...
        St = (n = "alert", a = "." + (r = "bs.alert"), c = (o = t).fn[n], u = {
            CLOSE: "close" + a,
            CLOSED: "closed" + a,
            ...
            return e.close = function (e) {
                ...
                if (o(t).removeClass("show"), o(t).hasClass("fade")) {
                    ...
                    o(t).one(Et.TRANSITION_END, function (e) {
        ...
        }(), o(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', f._handleDismiss(new f)), o.fn[n] = f._jQueryInterface, o.fn[n].Constructor = f, o.fn[n].noConflict = function () {
            return o.fn[n] = c, f._jQueryInterface
        }, f),
        At = (h = "button", g = "." + (m = "bs.button"), v = ".data-api", b = (p = t).fn[h], y = "active", "btn", _ = '[data-toggle^="button"]', '[data-toggle="buttons"]', "input", ".active", ".btn", w = {
            ...
            return e.toggle = function () {
                ...
                return this.each(function () {
                    var e = p(this).data(m);
                    e || (e = new n(this), p(this).data(m, e)), "toggle" === t && e[t]()
                })
            }, s(n, null, [{
                key: "VERSION",
                get: function () {
            ...
            return p.fn[h] = b, k._jQueryInterface
        }, k),
        Dt = (x = "carousel", j = "." + (T = "bs.carousel"), E = ".data-api", S = (C = t).fn[x], A = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            TOUCHEND: "touchend" + j,
            LOAD_DATA_API: "load" + j + E,
            CLICK_DATA_API: "click" + j + E
        }, "carousel", q = "active", "slide", "carousel-item-right", "carousel-item-left", "carousel-item-next", "carousel-item-prev", ".active", P = ".active.carousel-item", ".carousel-item", ".carousel-item-next, .carousel-item-prev", ".carousel-indicators", "[data-slide], [data-slide-to]", '[data-ride="carousel"]', L = function () {
            function r(e, t) {
            ...
            return e.next = function () {
                ...
                e || (this._isPaused = !0), this._element.querySelector(".carousel-item-next, .carousel-item-prev") && (Et.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, e.cycle = function (e) {
                ...
                if (!(e > this._items.length - 1 || e < 0))
                    if (this._isSliding) C(this._element).one(O.SLID, function () {
                        return t.to(e)
                    });
                    else {
                ...
                C(this._element).off(j), C.removeData(this._element, T), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, e._getConfig = function (e) {
                return e = l({}, A, e), Et.typeCheckConfig(x, e, D), e
            }, e._addEventListeners = function () {
                var t = this;
                this._config.keyboard && C(this._element).on(O.KEYDOWN, function (e) {
                    return t._keydown(e)
                }), "hover" === this._config.pause && (C(this._element).on(O.MOUSEENTER, function (e) {
                    return t.pause(e)
                }).on(O.MOUSELEAVE, function (e) {
                    return t.cycle(e)
                }), "ontouchstart" in document.documentElement && C(this._element).on(O.TOUCHEND, function () {
                ...
                var s = (o + (e === I ? -1 : 1)) % this._items.length;
                ...
                if (o = e === N ? (n = "carousel-item-left", i = "carousel-item-next", "left") : (n = "carousel-item-right", i = "carousel-item-prev", "right"), l && C(l).hasClass(q)) this._isSliding = !1;
                else if (!this._triggerSlideEvent(l, o).isDefaultPrevented() && s && l) {
                    this._isSliding = !0, d && this.pause(), this._setActiveIndicatorElement(l);
                    var u = C.Event(O.SLID, {
                        relatedTarget: l,
                        direction: o,
                        from: a,
                        to: c
                    ...
                    if (C(this._element).hasClass("slide")) {
                        ...
                        var f = Et.getTransitionDurationFromElement(s);
                        C(s).one(Et.TRANSITION_END, function () {
                            C(l).removeClass(n + " " + i).addClass(q), C(s).removeClass(q + " " + i + " " + n), r._isSliding = !1, setTimeout(function () {
                                return C(r._element).trigger(u)
                            }, 0)
                        }).emulateTransitionEnd(f)
                    } else C(s).removeClass(q), C(l).addClass(q), this._isSliding = !1, C(this._element).trigger(u);
                    d && this.cycle()
                }
                ...
                return this.each(function () {
                    ...
                    if (e || (e = new r(this, t), C(this).data(T, e)), "number" == typeof i) e.to(i);
                ...
                if (t) {
                    ...
                    if (n && C(n).hasClass("carousel")) {
                        var i = l({}, C(n).data(), C(this).data()),
                            o = this.getAttribute("data-slide-to");
                        o && (i.interval = !1), r._jQueryInterface.call(C(n), i), o && C(n).data(T).to(o), e.preventDefault()
                    }
                }
            }, s(r, null, [{
                key: "VERSION",
        ...
        }(), C(document).on(O.CLICK_DATA_API, "[data-slide], [data-slide-to]", L._dataApiClickHandler), C(window).on(O.LOAD_DATA_API, function () {
            for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), t = 0, n = e.length; t < n; t++) {
                var i = C(e[t]);
                L._jQueryInterface.call(i, i.data())
            }
        }), C.fn[x] = L._jQueryInterface, C.fn[x].Constructor = L, C.fn[x].noConflict = function () {
            return C.fn[x] = S, L._jQueryInterface
        }, L),
        Nt = (W = "collapse", B = "." + (M = "bs.collapse"), z = (H = t).fn[W], R = {
            toggle: !0,
            parent: ""
        }, F = {
            toggle: "boolean",
        ...
        }, Q = "show", K = "collapse", Y = "collapsing", $ = "collapsed", "width", "height", ".show, .collapsing", V = '[data-toggle="collapse"]', X = function () {
            function a(t, e) {
                this._isTransitioning = !1, this._element = t, this._config = this._getConfig(e), this._triggerArray = H.makeArray(document.querySelectorAll('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]'));
                for (var n = [].slice.call(document.querySelectorAll(V)), i = 0, o = n.length; i < o; i++) {
                    var r = n[i],
                        s = Et.getSelectorFromElement(r),
            ...
            var e = a.prototype;
            return e.toggle = function () {
                H(this._element).hasClass(Q) ? this.hide() : this.show()
            }, e.show = function () {
                var e, t, n = this;
                if (!(this._isTransitioning || H(this._element).hasClass(Q) || (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function (e) {
                        return e.getAttribute("data-parent") === n._config.parent
                })).length && (e = null), e && (t = H(e).not(this._selector).data(M)) && t._isTransitioning))) {
                    var i = H.Event(U.SHOW);
                    if (H(this._element).trigger(i), !i.isDefaultPrevented()) {
                        e && (a._jQueryInterface.call(H(e).not(this._selector), "hide"), t || H(e).data(M, null));
                        var o = this._getDimension();
                        H(this._element).removeClass(K).addClass(Y), this._element.style[o] = 0, this._triggerArray.length && H(this._triggerArray).removeClass($).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var r = "scroll" + (o[0].toUpperCase() + o.slice(1)),
                            s = Et.getTransitionDurationFromElement(this._element);
                        H(this._element).one(Et.TRANSITION_END, function () {
                            H(n._element).removeClass(Y).addClass(K).addClass(Q), n._element.style[o] = "", n.setTransitioning(!1), H(n._element).trigger(U.SHOWN)
                        }).emulateTransitionEnd(s), this._element.style[o] = this._element[r] + "px"
                    }
                }
            }, e.hide = function () {
                var e = this;
                if (!this._isTransitioning && H(this._element).hasClass(Q)) {
                    var t = H.Event(U.HIDE);
                    if (H(this._element).trigger(t), !t.isDefaultPrevented()) {
                        var n = this._getDimension();
                        this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", Et.reflow(this._element), H(this._element).addClass(Y).removeClass(K).removeClass(Q);
                        var i = this._triggerArray.length;
                        if (0 < i)
                            for (var o = 0; o < i; o++) {
                                var r = this._triggerArray[o],
                                    s = Et.getSelectorFromElement(r);
                                null !== s && (H([].slice.call(document.querySelectorAll(s))).hasClass(Q) || H(r).addClass($).attr("aria-expanded", !1))
                            }
                        this.setTransitioning(!0), this._element.style[n] = "";
                        var a = Et.getTransitionDurationFromElement(this._element);
                        H(this._element).one(Et.TRANSITION_END, function () {
                            e.setTransitioning(!1), H(e._element).removeClass(Y).addClass(K).trigger(U.HIDDEN)
                ...
                H.removeData(this._element, M), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
            }, e._getConfig = function (e) {
                return (e = l({}, R, e)).toggle = Boolean(e.toggle), Et.typeCheckConfig(W, e, F), e
                ...
                if (e) {
                    var n = H(e).hasClass(Q);
                    t.length && H(t).toggleClass($, !n).attr("aria-expanded", n)
                }
        ...
        }(), H(document).on(U.CLICK_DATA_API, V, function (e) {
        ...
        }), H.fn[W] = X._jQueryInterface, H.fn[W].Constructor = X, H.fn[W].noConflict = function () {
            return H.fn[W] = z, X._jQueryInterface
        }, X),
        It = (J = "dropdown", ee = "." + (Z = "bs.dropdown"), te = ".data-api", ne = (G = t).fn[J], ie = new RegExp("38|40|27"), oe = {
            HIDE: "hide" + ee,
            HIDDEN: "hidden" + ee,
            SHOW: "show" + ee,
            SHOWN: "shown" + ee,
            ...
            return e.toggle = function () {
                    ...
                    if (c._clearMenus(), !t) {
                        ...
                        if (G(e).trigger(i), !i.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var o = this._element;
                                "parent" === this._config.reference ? o = e : Et.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && G(e).addClass("position-static"), this._popper = new d(o, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === G(e).closest(".navbar-nav").length && G(document.body).children().on("mouseover", null, G.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), G(this._menu).toggleClass(se), G(e).toggleClass(se).trigger(G.Event(oe.SHOWN, n))
                        }
                    }
                }
            }, e.dispose = function () {
                ...
                return e = l({}, this.constructor.Default, G(this._element).data(), e), Et.typeCheckConfig(J, e, this.constructor.DefaultType), e
                ...
                return this.each(function () {
                    var e = G(this).data(Z);
                    if (e || (e = new c(this, "object" == typeof t ? t : null), G(this).data(Z, e)), "string" == typeof t) {
                    ...
                    for (var t = [].slice.call(document.querySelectorAll(le)), n = 0, i = t.length; n < i; n++) {
                        ...
                        if (e && "click" === e.type && (s.clickEvent = e), r) {
                            ...
                            if (G(o).hasClass(se) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && G.contains(o, e.target))) {
                                ...
                                G(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && G(document.body).children().off("mouseover", null, G.noop), t[n].setAttribute("aria-expanded", "false"), G(a).removeClass(se), G(o).removeClass(se).trigger(G.Event(oe.HIDDEN, s)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || G(e.target).closest(ce).length)) : ie.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !G(this).hasClass(re))) {
            ...
            e.stopPropagation()
        }), G.fn[J] = fe._jQueryInterface, G.fn[J].Constructor = fe, G.fn[J].noConflict = function () {
            return G.fn[J] = ne, fe._jQueryInterface
        }, fe),
        Ot = (he = "modal", ge = "." + (me = "bs.modal"), ve = (pe = t).fn[he], be = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
        ...
        }, "modal-scrollbar-measure", "modal-backdrop", we = "modal-open", ke = "fade", Ce = "show", ".modal-dialog", '[data-toggle="modal"]', '[data-dismiss="modal"]', xe = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Te = ".sticky-top", je = function () {
            function o(e, t) {
            ...
            return e.toggle = function (e) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    ...
                    var n = pe.Event(_e.SHOW, {
                        relatedTarget: e
                    });
                    pe(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), pe(document.body).addClass(we), this._setEscapeEvent(), this._setResizeEvent(), pe(this._element).on(_e.CLICK_DISMISS, '[data-dismiss="modal"]', function (e) {
                        return t.hide(e)
                    }), pe(this._dialog).on(_e.MOUSEDOWN_DISMISS, function () {
                        pe(t._element).one(_e.MOUSEUP_DISMISS, function (e) {
                ...
                if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                    var n = pe.Event(_e.HIDE);
                    if (pe(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        this._isShown = !1;
                        var i = pe(this._element).hasClass(ke);
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), pe(document).off(_e.FOCUSIN), pe(this._element).removeClass(Ce), pe(this._element).off(_e.CLICK_DISMISS), pe(this._dialog).off(_e.MOUSEDOWN_DISMISS), i) {
                ...
                return e = l({}, be, e), Et.typeCheckConfig(he, e, ye), e
                ...
                if (n) {
                    ...
                    pe(this._dialog).one(Et.TRANSITION_END, o).emulateTransitionEnd(r)
                } else o()
            }, e._enforceFocus = function () {
                var t = this;
                pe(document).off(_e.FOCUSIN).on(_e.FOCUSIN, function (e) {
                    document !== e.target && t._element !== e.target && 0 === pe(t._element).has(e.target).length && t._element.focus()
                })
            }, e._setEscapeEvent = function () {
                var t = this;
                this._isShown && this._config.keyboard ? pe(this._element).on(_e.KEYDOWN_DISMISS, function (e) {
                    27 === e.which && (e.preventDefault(), t.hide())
                }) : this._isShown || pe(this._element).off(_e.KEYDOWN_DISMISS)
            }, e._setResizeEvent = function () {
                var t = this;
                this._isShown ? pe(window).on(_e.RESIZE, function (e) {
                    return t.handleUpdate(e)
                }) : pe(window).off(_e.RESIZE)
            }, e._hideModal = function () {
                var e = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._isTransitioning = !1, this._showBackdrop(function () {
                    pe(document.body).removeClass(we), e._resetAdjustments(), e._resetScrollbar(), pe(e._element).trigger(_e.HIDDEN)
                })
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", n && this._backdrop.classList.add(n), pe(this._backdrop).appendTo(document.body), pe(this._element).on(_e.CLICK_DISMISS, function (e) {
                    ...
                    if (pe(this._element).hasClass(ke)) {
                        ...
                        pe(this._backdrop).one(Et.TRANSITION_END, o).emulateTransitionEnd(r)
                    } else o()
                } else e && e()
                ...
                if (this._isBodyOverflowing) {
                    var e = [].slice.call(document.querySelectorAll(xe)),
                        t = [].slice.call(document.querySelectorAll(Te));
                    pe(e).each(function (e, t) {
                        var n = t.style.paddingRight,
                            i = pe(t).css("padding-right");
                        pe(t).data("padding-right", n).css("padding-right", parseFloat(i) + o._scrollbarWidth + "px")
                    }), pe(t).each(function (e, t) {
                        var n = t.style.marginRight,
                            i = pe(t).css("margin-right");
                        pe(t).data("margin-right", n).css("margin-right", parseFloat(i) - o._scrollbarWidth + "px")
                    });
                ...
                return this.each(function () {
                    var e = pe(this).data(me),
                        t = l({}, be, pe(this).data(), "object" == typeof n && n ? n : {});
                    if (e || (e = new o(this, t), pe(this).data(me, e)), "string" == typeof n) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n](i)
        ...
        }(), pe(document).on(_e.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
            var t, n = this,
                i = Et.getSelectorFromElement(this);
            i && (t = document.querySelector(i));
            var o = pe(t).data(me) ? "toggle" : l({}, pe(t).data(), pe(this).data());
            "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
            var r = pe(t).one(_e.SHOW, function (e) {
                e.isDefaultPrevented() || r.one(_e.HIDDEN, function () {
                    pe(n).is(":visible") && n.focus()
                })
            });
            je._jQueryInterface.call(pe(t), o, this)
        }), pe.fn[he] = je._jQueryInterface, pe.fn[he].Constructor = je, pe.fn[he].noConflict = function () {
            return pe.fn[he] = ve, je._jQueryInterface
        }, je),
        qt = (Se = "tooltip", De = "." + (Ae = "bs.tooltip"), Ne = (Ee = t).fn[Se], Ie = "bs-tooltip", Oe = new RegExp("(^|\\s)" + Ie + "\\S+", "g"), Le = {
            animation: !0,
        ...
        }, Me = "fade", Be = "show", ".tooltip-inner", ".arrow", ze = "hover", Re = "focus", "click", "manual", Fe = function () {
            function i(e, t) {
            ...
            return e.enable = function () {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        if (Ee(this.getTipElement()).hasClass(Be)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    i.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && Ee(i).addClass(Me);
                    ...
                    var a = !1 === this.config.container ? document.body : Ee(document).find(this.config.container);
                    Ee(i).data(this.constructor.DATA_KEY, this), Ee.contains(this.element.ownerDocument.documentElement, this.tip) || Ee(i).appendTo(a), Ee(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new d(this.element, i, {
                        placement: s,
                        modifiers: {
                            offset: {
                    ...
                    }), Ee(i).addClass(Be), "ontouchstart" in document.documentElement && Ee(document.body).children().on("mouseover", null, Ee.noop);
                    var l = function () {
                        t.config.animation && t._fixTransition();
                        var e = t._hoverState;
                        t._hoverState = null, Ee(t.element).trigger(t.constructor.Event.SHOWN), "out" === e && t._leave(null, t)
                    };
                    if (Ee(this.tip).hasClass(Me)) {
                        var c = Et.getTransitionDurationFromElement(this.tip);
                        Ee(this.tip).one(Et.TRANSITION_END, l).emulateTransitionEnd(c)
                    } else l()
                }
            }, e.hide = function (e) {
                var t = this,
                    ...
                    o = function () {
                        t._hoverState !== He && n.parentNode && n.parentNode.removeChild(n), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), Ee(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                    };
                if (Ee(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (Ee(n).removeClass(Be), "ontouchstart" in document.documentElement && Ee(document.body).children().off("mouseover", null, Ee.noop), this._activeTrigger.click = !1, this._activeTrigger[Re] = !1, this._activeTrigger[ze] = !1, Ee(this.tip).hasClass(Me)) {
                        var r = Et.getTransitionDurationFromElement(n);
                        Ee(n).one(Et.TRANSITION_END, o).emulateTransitionEnd(r)
                    } else o();
                    this._hoverState = ""
                }
            }, e.update = function () {
                ...
                Ee(this.getTipElement()).addClass(Ie + "-" + e)
            }, e.getTipElement = function () {
                return this.tip = this.tip || Ee(this.config.template)[0], this.tip
            }, e.setContent = function () {
                var e = this.getTipElement();
                this.setElementContent(Ee(e.querySelectorAll(".tooltip-inner")), this.getTitle()), Ee(e).removeClass(Me + " " + Be)
                ...
                this.config.trigger.split(" ").forEach(function (e) {
                    if ("click" === e) Ee(i.element).on(i.constructor.Event.CLICK, i.config.selector, function (e) {
                        ...
                        var t = e === ze ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                            n = e === ze ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
                ...
                (t = t || Ee(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), Ee(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusin" === e.type ? Re : ze] = !0), Ee(t.getTipElement()).hasClass(Be) || t._hoverState === He ? t._hoverState = He : (clearTimeout(t._timeout), t._hoverState = He, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function () {
                    t._hoverState === He && t.show()
                }, t.config.delay.show) : t.show())
            }, e._leave = function (e, t) {
                var n = this.constructor.DATA_KEY;
                (t = t || Ee(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), Ee(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? Re : ze] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
                ...
                return "number" == typeof (e = l({}, this.constructor.Default, Ee(this.element).data(), "object" == typeof e && e ? e : {})).delay && (e.delay = {
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), Et.typeCheckConfig(Se, e, this.constructor.DefaultType), e
                ...
                null === e.getAttribute("x-placement") && (Ee(e).removeClass(Me), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
            }, i._jQueryInterface = function (n) {
                return this.each(function () {
                    var e = Ee(this).data(Ae),
                        t = "object" == typeof n && n;
                    if ((e || !/dispose|hide/.test(n)) && (e || (e = new i(this, t), Ee(this).data(Ae, e)), "string" == typeof n)) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
                })
        ...
        }(), Ee.fn[Se] = Fe._jQueryInterface, Ee.fn[Se].Constructor = Fe, Ee.fn[Se].noConflict = function () {
            return Ee.fn[Se] = Ne, Fe._jQueryInterface
        }, Fe),
        Pt = (Qe = "popover", Ye = "." + (Ke = "bs.popover"), $e = (Ue = t).fn[Qe], Ve = "bs-popover", Xe = new RegExp("(^|\\s)" + Ve + "\\S+", "g"), Ge = l({}, qt.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            ...
            return o.isWithContent = function () {
                ...
                Ue(this.getTipElement()).addClass(Ve + "-" + e)
                ...
                return this.each(function () {
                    var e = Ue(this).data(Ke),
                        t = "object" == typeof n ? n : null;
                    if ((e || !/destroy|hide/.test(n)) && (e || (e = new i(this, t), Ue(this).data(Ke, e)), "string" == typeof n)) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
                })
        ...
        }(qt), Ue.fn[Qe] = et._jQueryInterface, Ue.fn[Qe].Constructor = et, Ue.fn[Qe].noConflict = function () {
            return Ue.fn[Qe] = $e, et._jQueryInterface
        }, et),
        Lt = (nt = "scrollspy", ot = "." + (it = "bs.scrollspy"), rt = (tt = t).fn[nt], st = {
            offset: 10,
            method: "auto",
            target: ""
        }, at = {
            ...
            return e.refresh = function () {
                ...
                n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(ct), n.addClass(ct)) : (n.addClass(ct), n.parents(dt).prev(ut + ", " + ft).addClass(ct), n.parents(dt).prev(".nav-item").children(ut).addClass(ct)), tt(this._scrollElement).trigger(lt.ACTIVATE, {
                    relatedTarget: t
                })
            }, e._clear = function () {
            ...
            return tt.fn[nt] = rt, ht._jQueryInterface
        }, ht),
        Ht = (vt = "." + (gt = "bs.tab"), bt = (mt = t).fn.tab, yt = {
            HIDE: "hide" + vt,
            HIDDEN: "hidden" + vt,
            SHOW: "show" + vt,
            SHOWN: "shown" + vt,
            CLICK_DATA_API: "click" + vt + ".data-api"
        }, "dropdown-menu", _t = "active", "disabled", "fade", "show", ".dropdown", ".nav, .list-group", wt = ".active", kt = "> li > .active", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', ".dropdown-toggle", "> .dropdown-menu .active", Ct = function () {
            function i(e) {
                this._element = e
            }
            var e = i.prototype;
            return e.show = function () {
                var n = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && mt(this._element).hasClass(_t) || mt(this._element).hasClass("disabled"))) {
                    var e, i, t = mt(this._element).closest(".nav, .list-group")[0],
                        o = Et.getSelectorFromElement(this._element);
                    if (t) {
                        var r = "UL" === t.nodeName ? kt : wt;
                        i = (i = mt.makeArray(mt(t).find(r)))[i.length - 1]
                    }
                    var s = mt.Event(yt.HIDE, {
                        relatedTarget: this._element
                    }),
                        a = mt.Event(yt.SHOW, {
                            relatedTarget: i
                ...
                var i = this,
                    o = ("UL" === t.nodeName ? mt(t).find(kt) : mt(t).children(wt))[0],
                    r = n && o && mt(o).hasClass("fade"),
                    s = function () {
                        return i._transitionComplete(e, o, n)
                    };
                if (o && r) {
                    var a = Et.getTransitionDurationFromElement(o);
                    mt(o).one(Et.TRANSITION_END, s).emulateTransitionEnd(a)
                } else s()
            }, e._transitionComplete = function (e, t, n) {
                if (t) {
                    mt(t).removeClass("show " + _t);
                    var i = mt(t.parentNode).find("> .dropdown-menu .active")[0];
                    i && mt(i).removeClass(_t), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                }
                if (mt(e).addClass(_t), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), Et.reflow(e), mt(e).addClass("show"), e.parentNode && mt(e.parentNode).hasClass("dropdown-menu")) {
                    var o = mt(e).closest(".dropdown")[0];
                    if (o) {
        ...
        }(), mt(document).on(yt.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
            ...
            return mt.fn.tab = bt, Ct._jQueryInterface
        }, Ct);
    ! function (e) {
        if (void 0 === e) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
        var t = e.fn.jquery.split(" ")[0].split(".");
        if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || 4 <= t[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
    }(t), e.Util = Et, e.Alert = St, e.Button = At, e.Carousel = Dt, e.Collapse = Nt, e.Dropdown = It, e.Modal = Ot, e.Popover = Pt, e.Scrollspy = Lt, e.Tab = Ht, e.Tooltip = qt, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}),
function () {
...
function () {
        ...
        var n = function (i, d) {
            ...
            if (d.getElementsByClassName) {
                var u, f, p = d.documentElement,
                    ...
                    y = function (e, t) {
                        b(e, t) || e.setAttribute("class", (e[h]("class") || "").trim() + " " + t)
                    },
                    _ = function (e, t) {
                        var n;
                        (n = b(e, t)) && e.setAttribute("class", (e[h]("class") || "").replace(n, " "))
                    },
                    w = function (t, n, e) {
                ...
                var S = (ne = /^img$/i, ie = /^iframe$/i, oe = "onscroll" in i && !/glebot/.test(navigator.userAgent), ae = -1, le = function (e) {
                    ...
                    for (R -= t, Q += t, F -= t, U += t; o && (i = i.offsetParent) && i != d.body && i != p;) (o = 0 < (x(i, "opacity") || 1)) && "visible" != x(i, "overflow") && (n = i.getBoundingClientRect(), o = U > n.left && F < n.right && Q > n.top - 1 && R < n.bottom + 1);
                    return o
                }, V = de = function () {
                    var e, t, n, i, o, r, s, a, l, c = u.elements;
                    if ((W = f.loadMode) && se < 8 && (e = c.length)) {
                        t = 0, ae++, null == Y && ("expand" in f || (f.expand = 500 < p.clientHeight && 500 < p.clientWidth ? 500 : 370), K = f.expand, Y = K * f.expFactor), re < Y && se < 1 && 2 < ae && 2 < W && !d.hidden ? (re = Y, ae = 0) : re = 1 < W && 1 < ae && se < 6 ? K : 0;
                        for (; t < e; t++)
                            if (c[t] && !c[t]._lazyRace)
                                if (oe)
                                    if ((a = c[t][h]("data-expand")) && (r = 1 * a) || (r = re), l !== r && (B = innerWidth + r * $, z = innerHeight + r, s = -1 * r, l = r), n = c[t].getBoundingClientRect(), (Q = n.bottom) >= s && (R = n.top) <= z && (U = n.right) >= s * $ && (F = n.left) <= B && (Q || U || F || R) && (f.loadHidden || "hidden" != x(c[t], "visibility")) && (L && se < 3 && !a && (W < 3 || ae < 4) || ce(c[t], r))) {
                                        if (ve(c[t]), o = !0, 9 < se) break
                                    } else !o && L && !i && se < 4 && ae < 4 && 2 < W && (P[0] || f.preloadAfterLoad) && (P[0] || !a && (Q || U || F || R || "auto" != c[t][h](f.sizesAttr))) && (i = P[0] || c[t]);
                                else ve(c[t]);
                        i && !o && ve(i)
                    }
                    ...
                    y(e.target, f.loadedClass), _(e.target, f.loadingClass), w(e.target, he), k(e.target, "lazyloaded")
                }), he = function (e) {
                    pe({
                        target: e.target
                    })
                }, me = function (e) {
                    var t, n = e[h](f.srcsetAttr);
                    (t = f.customMedia[e[h]("data-media") || e[h]("media")]) && e.setAttribute("media", t), n && e.setAttribute("srcset", n)
                }, ge = e(function (e, t, n, i, o) {
                    var r, s, a, l, c, d;
                    (c = k(e, "lazybeforeunveil", t)).defaultPrevented || (i && (n ? y(e, f.autosizesClass) : e.setAttribute("sizes", i)), s = e[h](f.srcsetAttr), r = e[h](f.srcAttr), o && (a = e.parentNode, l = a && g.test(a.nodeName || "")), d = t.firesLoad || "src" in e && (s || r || l), c = {
                        target: e
                    }, d && (w(e, le, !0), clearTimeout(H), H = m(le, 2500), y(e, f.loadingClass), w(e, he, !0)), l && v.call(a.getElementsByTagName("source"), me), s ? e.setAttribute("srcset", s) : r && !l && (ie.test(e.nodeName) ? function (t, n) {
                        try {
                    ...
                    if (!L) {
                        if (r.now() - M < 999) return void m(be, 999);
                        var e = E(function () {
                            f.loadMode = 3, ue()
                        });
                    ...
                    _: function () {
                        M = r.now(), u.elements = d.getElementsByClassName(f.lazyClass), P = d.getElementsByClassName(f.lazyClass + " " + f.preloadClass), $ = f.hFac, t("scroll", ue, !0), t("resize", ue, !0), i.MutationObserver ? new MutationObserver(ue).observe(p, {
                            childList: !0,
                            subtree: !0,
                            attributes: !0
                        }) : (p[s]("DOMNodeInserted", ue, !0), p[s]("DOMAttrModified", ue, !0), setInterval(ue, 999)), t("hashchange", ue, !0), ["focus", "mouseover", "click", "load", "transitionend", "animationend", "webkitAnimationEnd"].forEach(function (e) {
                            d[s](e, ue, !0)
                    ...
                    unveil: ve = function (e) {
                        var t, n = ne.test(e.nodeName),
                            i = n && (e[h](f.sizesAttr) || e[h]("sizes")),
                            o = "auto" == i;
                        (!o && L || !n || !e[h]("src") && !e.srcset || e.complete || b(e, f.errorClass) || !b(e, f.lazyClass)) && (t = k(e, "lazyunveilread").detail, o && A.updateElem(e, !0, e.offsetWidth), e._lazyRace = !0, se++, ge(e, t, o, i, n))
                    }
                }),
            ...
            var N, I, O, q;
            var P, L, H, W, M, B, z, R, F, U, Q, K, Y, $, V, X, G, J, Z, ee, te, ne, ie, oe, re, se, ae, le, ce, de, ue, fe, pe, he, me, ge, ve, be;
    ...
    function (e) {
        ...
        //                    var p = L('<div class="jq-selectbox__dropdown">' + t + "<ul>" + N + "</ul></div>");
        //                    c.append(p);
        //                    var h = L("ul", p),
        //                        m = L("li", p),
        //                        g = L("input", p),
        ...
        //                    }
        //                    b > c.width() && p.width(b), "" === D.first().text() && "" !== O.data("placeholder") && m.first().hide();
        ...
        //                        top: k
        //                    }), E = k), p.hide(), T.length && (D.first().text() != f.text() && c.addClass("changed"), c.data("jqfs-class", T.data("jqfs-class")), c.addClass(T.data("jqfs-class"))), O.is(":disabled")) return c.addClass("disabled");
        //                    a.click(function () {
        ...
        //                                });
        //                                var e = function () {
        //                                    h.css("max-height", Math.floor((o - 20 - C) / n) * n)
        //                                };
        //                                e(), h.css("max-height", s), "none" != x && h.css("max-height", x), o < p.outerHeight() + 20 && e()
        //                            };
        ...
        //                                });
        //                                var e = function () {
        //                                    h.css("max-height", Math.floor((i - t.scrollTop() - 20 - C) / n) * n)
        //                                };
        //                                e(), h.css("max-height", s), "none" != x && h.css("max-height", x), i - t.scrollTop() - 20 < p.outerHeight() + 20 && e()
        //                            }(), c.removeClass("dropdown").addClass("dropup")) : !1 === l || 0 === l ? r + C + 20 < o && (a(), c.removeClass("dropup").addClass("dropdown")) : (p.height("auto").css({
        //                                bottom: "auto",
        //                                top: E
        //                            }), h.css("max-height", s), "none" != x && h.css("max-height", x)), c.offset().left + p.outerWidth() > t.width() && p.css({
        //                                left: "auto",
        //                                right: 0
        //                            }), L("div.jqselect").css({
        //                                zIndex: d - 1
        ...
        //                                zIndex: d
        //                            }), p.is(":hidden") ? (L("div.jq-selectbox__dropdown:visible").hide(), p.show(), c.addClass("opened focused"), q.onSelectOpened.call(c)) : (p.hide(), c.removeClass("opened dropup dropdown"), L("div.jq-selectbox").filter(".opened").length && q.onSelectClosed.call(c)), g.length && (g.val("").keyup(), v.hide(), g.keyup(function () {
        //                                var e = L(this).val();
        //                                m.each(function () {
        ...
        //                            })), m.filter(".selected").length && ("" === O.val() ? h.scrollTop(0) : (h.innerHeight() / n % 2 != 0 && (n /= 2), h.scrollTop(h.scrollTop() + m.filter(".selected").position().top - h.innerHeight() / 2 + n))), S(h)
        //                        }
        //                    }), m.hover(function () {
        ...
        //                        }
        //                        p.hide(), c.removeClass("opened dropup dropdown"), q.onSelectClosed.call(c)
        //                    }), p.mouseout(function () {
...
jQuery.noConflict(), window.lazySizesConfig = window.lazySizesConfig || {}, window.lazySizesConfig.expand = 500,
    function (a) {
        jQuery.cachedScript = function (e, t) {
            ...
            "undefined" != typeof brs_l10n ? Berserk.attachBehaviors(a("body"), Berserk.settings) : function () {
                if (a("[data-brk-library]:not(.brk-library-rendered)").addClass("brk-library-rendered").each(function () {
                        ...
                        for (i in e) void 0 === r[e[i]] && (r[e[i]] = 1, c(e[i]))
                }), Object.keys(o.css).length) {
                    var e = "",
                        t = "";
                    for (i in d && (t = 'class="brk-css-add" '), o.css) console.log("CSS added: " + o.css[i]), e += "<link " + t + 'rel="stylesheet"  href="' + o.css[i] + '">';
                    a("head").append(e)
                }
                if (Object.keys(o.js).length) {
                    var n = 0;
                    for (i in o.js) console.log("JS added: " + o.js[i]), a.cachedScript(o.js[i]).done(function (e, t) {
                        n += 1, Object.keys(o.js).length === n && (Berserk.attachBehaviors(a("body"), Berserk.settings), o = {
                            css: {},
                            js: {}
                        })
                    })
            ...
            a.each({
                ...
                ".font__family-poppins": "Poppins:300,400,700",
        ...
        e.length && e.each(function () {
            ...
            attach: function (e, t) {
                a("a:not(.nohash-animat)").on("click", function (e) {
                    if ("" !== this.hash && "#top" !== this.hash && "collapse" !== this.getAttribute("data-toggle") && "tab" !== this.getAttribute("data-toggle") && !a(this).hasClass("fancybox") && !a(this).parent().parent().get(0).getAttribute("data-tabgroup")) {
                        e.preventDefault();
                        var t = this.hash;
                        a("html, body").animate({
        ...
        }, a("body").hasClass("brk-bordered-theme") ? a(":root").css("--b-radius", a("body").attr("data-border") + "px") : a(":root").css("--b-radius", ""), Berserk.behaviors.counter_lib_init = {
            attach: function (e, t) {
                var n;
        ...
        var o = {
            ...
            r = {},
            t = {
                "Content/css/assets/brk-header-elements.css": !0,
                "Content/css/components/theme-options.css": !0,
                "Content/css/components/accordions.css": !0,
                "Content/css/components/tabs.css": !0,
                "Content/css/components/buttons.css": !0,
                "Content/css/components/pricing-tables.css": !0,
                "Content/css/components/testimonials.css": !0,
                "Content/css/components/CFA.css": !0,
                "Content/css/components/form-controls.css": !0,
                "Content/css/components/flip-boxes.css": !0,
                "Content/css/components/elements.css": !0,
                "Content/vendor/fancybox/css/jquery.fancybox.min.css": !0,
                "Content/js/assets/brk-customizer.js": !0,
                "Content/js/assets/brk-header.js": !0,
                "Content/js/components/accordions.js": !0,
                "Content/js/components/tabs.js": !0,
                "Content/js/components/buttons.js": !0,
                "Content/js/components/form-controls.js": !0,
                "Content/vendor/formStyler/js/jquery.formstyler.min.js": !0,
                "Content/css/components/footer.css": !0,
                "Content/css/components/image-map.css": !0,
                "Content/css/components/media-embeds.css": !0,
                "Content/js/components/media-embeds.js": !0,
                "Content/js/components/image-map.js": !0,
                "Content/js/components/footer.js": !0,
                "Content/js/components/portfolio-masonry.js": !0,
                "Content/js/components/progress-bars.js": !0,
                "Content/js/components/portfolio-rows.js": !0,
                "Content/js/components/steps.js": !0,
                "Content/js/components/parallax-video.js": !0,
                "Content/js/components/counter.js": !0,
                "Content/js/components/sliders.js": !0,
                "Content/js/components/breadcrumbs.js": !0,
                "Content/js/components/info-box.js": !0,
                "Content/js/components/shop-components-tiles.js": !0,
                "Content/js/components/blog-page.js": !0,
                "https://maps.googleapis.com/maps/api/js?key=AIzaSyCSzRKxiq0GL_aWvND_lYwciIe4moNzNMY": !0,
                "Content/js/components/google-maps.js": !0,
                "Content/js/assets/twitter-init.js": !0
            },
        //    str = JSON.stringify(t);
        //try {
        //    str = str.replace(/Content/g, getDomain() + 'Content');
        //    t = JSON.parse(str);
        //} catch (e)
        //{
        //}
            ...
            s = {
                component__map: {
                    js: ["https://maps.googleapis.com/maps/api/js?key=AIzaSyCSzRKxiq0GL_aWvND_lYwciIe4moNzNMY", "Content/js/components/google-maps.js"]
                },
                //twitter_init: {
                //    js: ["/Content/js/assets/twitter-init.js"]
                //}
            },
            l = {};
        function c(e) {
            if (void 0 !== n[e].dependency)
                for (i in n[e].dependency) void 0 === r[n[e].dependency[i]] && (r[n[e].dependency[i]] = 1, c(n[e].dependency[i]));
            if (void 0 !== n[e].css)
                for (i in n[e].css) t[n[e].css[i]] || (t[n[e].css[i]] = !0, o.css[n[e].css[i]] = n[e].css[i]);
            if (void 0 !== n[e].js)
                for (i in n[e].js) t[n[e].js[i]] || (t[n[e].js[i]] = !0, o.js[n[e].js[i]] = n[e].js[i])
        }
        a.each(s, function (e, t) {
            ...
            t && function (e) {
                var t = e.split(",");
                for (iv in t)
                    if (s[t[iv]] && void 0 !== s[t[iv]].js)
                        for (i in s[t[iv]].js)
                            if (!l[s[t[iv]].js[i]]) {
                                l[s[t[iv]].js[i]] = !0;
                                var n = "undefined" != typeof brk && void 0 !== brk.shorcodesurl && -1 !== s[t[iv]].js[i].indexOf("//") ? brk.shorcodesurl : "";
                                console.log("JS added: " + n + s[t[iv]].js[i]), a.cachedScript(n + s[t[iv]].js[i]).done(function (e, t) {
        ...
        var n = {
            ...
            waypoints: {
                js: ["/Content/vendor/waypoints/js/jquery.waypoints.min.js"]
            },
            "pe-icon-7": {
                css: ["/Content/vendor/pe-icon-7-stroke/css/pe-icon-7-stroke.css"]
            },
            slider__swiper: {
                dependency: ["component__sliders_css"],
                css: ["/Content/vendor/swiper/css/swiper.min.css"],
                js: ["/Content/vendor/swiper/js/swiper.min.js", "/Content/js/assets/swiper-skin.js"]
            },
            slider__slick: {
                css: ["/Content/vendor/slickCarousel/css/slick.css", "/Content/css/components/sliders.css"],
                js: ["/Content/vendor/slickCarousel/js/slick.min.js", "/Content/js/assets/sliders-skin.js"]
            },
            slider__rotator: {
                js: ["/Content/js/assets/rotation-slider.js"]
            },
            jquerySlider: {
                js: ["/Content/vendor/jquerySlider/js/jquery-ui.min.js"]
            },
            isotope: {
                js: ["/Content/vendor/isotope/js/isotope.pkgd.min.js"]
            },
            datatables_js: {
                js: ["/Content/vendor/datatables/js/jquery.dataTables.min.js"]
            },
            scrollbar: {
                css: ["/Content/vendor/jquery.scrollbar/css/jquery.scrollbar.css"],
                js: ["/Content/vendor/jquery.scrollbar/js/jquery.scrollbar.min.js"]
            },
            assets_particleground: {
                js: ["/Content/js/assets/jquery.particleground.min.js"]
            },
            assets_fss: {
                js: ["/Content/js/assets/fss.min.js"]
            },
            assets_skrollr: {
                js: ["/Content/js/assets/skrollr.min.js"]
            },
            paper: {
                js: ["/Content/vendor/paper/js/paper-full.js"]
            },
            anime: {
                js: ["/Content/vendor/animejs/js/anime.min.js", "/Content/js/assets/brk-hover3d.js"]
            },
            fancybox: {
                css: ["/Content/vendor/fancybox/css/jquery.fancybox.min.css"],
                js: ["/Content/vendor/fancybox/js/jquery.fancybox.min.js"]
            },
            odometer: {
                js: ["/Content/vendor/odometer/js/odometer.min.js"]
            },
            jqueryAutocomplete: {
                css: ["/Content/vendor/jqueryAutocomplete/css/jquery-ui.css"],
                js: ["/Content/vendor/jqueryAutocomplete/js/jquery-ui.min.js"]
            },
            assets__typing_rotator: {
                js: ["/Content/js/assets/typing-rotator.js"]
            },
            assets__image_caption: {
                dependency: ["anime"],
                js: ["/Content/js/components/image-caption-parallax.js"]
            },
            "brk-customizer": {
                dependency: ["component__accordions"],
                css: ["/Content/css/components/theme-options.css"],
                js: ["/Content/js/assets/brk-customizer.js"]
            },
            twitter_init: {
                js: ["/Content/js/assets/twitter-init.js"]
            },
            component__social_links: {
                css: ["/Content/css/components/social-links.css"]
            },
            component__breadcrumbs_css: {
                css: ["/Content/css/components/breadcrumbs.css"]
            },
            component__breadcrumbs_js: {
                js: ["/Content/js/components/breadcrumbs.js"]
            },
            ...
            component__accordions: {
                css: ["/Content/css/components/accordions.css"],
                js: ["/Content/js/components/accordions.js"]
            },
            component__sliders: {
                js: ["/Content/js/components/sliders.js"],
                dependency: ["component__sliders_css"]
            },
            component__sliders_css: {
                css: ["/Content/css/components/sliders.css"]
            },
            component__content_slider: {
                css: ["/Content/css/components/content-sliders.css"]
            },
            component__team: {
                css: ["/Content/css/components/team.css"],
                js: ["/Content/js/components/team.js"]
            },
            component__social_block: {
                css: ["/Content/css/components/social.css"]
            },
            component__flip_box_css: {
                css: ["/Content/css/components/flip-boxes.css"]
            },
            component__flip_box: {
            ...
            component__title: {
                css: ["/Content/css/components/titles.css"],
                dependency: ["assets__typing_rotator"]
            },
            component__typing_rotator: {
                css: ["/Content/css/components/typing-rotator.css"]
            },
            component__dividers: {
                css: ["/Content/css/components/dividers.css"]
            },
            component__progress_circle: {
                css: ["/Content/css/components/progress-circles.css"],
                js: ["/Content/js/components/progress-circles.js"]
            },
            component__counter: {
                css: ["/Content/css/components/counter.css"],
                js: ["/Content/js/components/counter.js"],
                dependency: ["waypoints"]
            },
            component__button: {
                css: ["/Content/css/components/buttons.css"],
                js: ["/Content/js/components/buttons.js"]
            },
            component__alert: {
                css: ["/Content/css/components/alerts.css"],
                js: ["/Content/js/components/alerts.js"]
            },
            component__form: {
                css: ["/Content/css/components/form-controls.css"],
                js: ["/Content/vendor/formStyler/js/jquery.formstyler.min.js", "/Content/js/components/form-controls.js"]
            },
            component__forum_post: {
                css: ["/Content/css/components/forum-post.css"]
            },
            component__forum_main: {
                css: ["/Content/css/components/forum-main.css"]
            },
            component__forum_author: {
                css: ["/Content/css/components/forum-author.css"]
            },
            component__countdown: {
                css: ["/Content/css/components/countdown.css"],
                js: ["/Content/vendor/jqueryCountdown/js/jquery.countdown.min.js", "/Content/vendor/underscore/js/underscore-min.js", "/Content/js/components/countdown.js"]
            },
            component__image_frames: {
                css: ["/Content/css/components/image-frames.css"]
            },
            component__info_box: {
                css: ["/Content/css/components/info-box.css"],
                js: ["/Content/js/components/info-box.js"],
                dependency: ["waypoints"]
            },
            component__call_to_action: {
                css: ["/Content/css/components/CFA.css"],
                js: ["/Content/js/components/CFA.js"]
            },
            component__list: {
                css: ["/Content/css/components/lists.css"]
            },
            component__map: {
                css: ["/Content/css/components/google-maps.css"],
                js: ["https://maps.googleapis.com/maps/api/js?key=AIzaSyCSzRKxiq0GL_aWvND_lYwciIe4moNzNMY", "/Content/js/components/google-maps.js"]
            },
            component__panel: {
                css: ["/Content/css/components/panels.css"]
            },
            component__pricing_table: {
                css: ["/Content/css/components/pricing-tables.css"]
            },
            component__blog_css: {
                css: ["/Content/css/components/blog.css"]
            },
            component__blog_js: {
                js: ["/Content/js/components/blog.js"]
            },
            component__blog: {
                js: ["/Content/js/components/blog.js"],
            ...
            component__blog_grid: {
                css: ["/Content/css/components/blog-grid.css"]
            },
            component__blog_page_css: {
                css: ["/Content/css/components/blog-page.css"]
            },
            component__blog_page: {
                js: ["/Content/js/components/blog-page.js"],
                dependency: ["component__social_links", "component__blog", "component__blog_page_css"]
            },
            component__widgets_css: {
                css: ["/Content/css/components/widgets.css"]
            },
            component__widgets: {
                js: ["/Content/js/components/widgets.js"],
                dependency: ["component__widgets_css", "slider__slick"]
            },
            component__media_embeds: {
                css: ["/Content/css/components/media-embeds.css"],
                js: ["/Content/js/components/media-embeds.js"]
            },
            component__pagination: {
                css: ["/Content/css/components/pagination.css"],
                js: ["/Content/js/components/pagination.js"]
            },
            component__index: {
                css: ["/Content/css/components/index.css"],
                js: ["/Content/js/components/index.js"],
                dependency: ["jqueryAutocomplete", "isotope"]
            },
            component__team_page_css: {
                css: ["/Content/css/components/team-member.css"]
            },
            component__team_page: {
                dependency: ["component__social_links", "component__team_page_css"]
            },
            "component__portfolio_page-styles": {
                css: ["/Content/css/components/portfolio-page.css"]
            },
            component__portfolio_page: {
                dependency: ["component__portfolio_page-styles", "anime"]
            },
            component__portfolio_list: {
                css: ["/Content/css/components/portfolio-list.css"]
            },
            component__portfolio_grid: {
                css: ["/Content/css/components/portfolio-grid.css"],
                js: ["/Content/js/components/portfolio-grid.js"],
                dependency: ["anime"]
            },
            component__portfolio_row: {
                css: ["/Content/css/components/portfolio-rows.css"],
                js: ["/Content/js/components/portfolio-rows.js"],
                dependency: ["isotope", "anime"]
            },
            component__portfolio_isotope_css: {
                css: ["/Content/css/components/portfolio-isotope.css"]
            },
            component__portfolio_isotope: {
                js: ["/Content/js/components/portfolio-isotope.js"],
                dependency: ["component__portfolio_isotope_css", "isotope", "anime"]
            },
            component__portfolio_category: {
                css: ["/Content/css/components/portfolio-categories.css"],
                js: ["/Content/js/components/portfolio-categories.js"]
            },
            component__portfolio_galleries: {
                css: ["/Content/css/components/portfolio-galleries.css"],
                dependency: ["component__social_links"]
            },
            component__portfolio_masonry: {
                css: ["/Content/css/components/portfolio-masonry.css"],
                js: ["/Content/js/components/portfolio-masonry.js"],
                dependency: ["component__media_embeds", "isotope", "component__content_slider"]
            },
            "component__portfolio_masonry-2": {
                css: ["/Content/css/components/portfolio-masonry-2.css"],
                dependency: ["component__portfolio_isotope"]
            },
            component__progress_bar: {
                css: ["/Content/css/components/progress-bars.css"],
                js: ["/Content/js/components/progress-bars.js"]
            },
            component__sequence: {
                css: ["/Content/css/components/sequence.css"]
            },
            component__services: {
                css: ["/Content/css/components/services.css"]
            },
            component__shape_box: {
                css: ["/Content/css/components/shape-box.css"],
                js: ["/Content/js/components/shape-box.js"]
            },
            component__steps: {
                css: ["/Content/css/components/steps.css"],
                js: ["/Content/js/components/steps.js"]
            },
            component__tabs: {
                css: ["/Content/css/components/tabs.css"],
                js: ["/Content/js/components/tabs.js"]
            },
            component__tabbed_contents: {
                css: ["/Content/css/components/tabbed-contents.css"],
                js: ["/Content/js/components/tabs.js"]
            },
            component__testimonials: {
                css: ["/Content/css/components/testimonials.css"]
            },
            component__toggleswitch: {
            ...
            component__tiles: {
                css: ["/Content/css/components/tiles.css"]
            },
            component__title_section: {
                css: ["/Content/css/components/section-titles.css"]
            },
            component__delimiters: {
                css: ["/Content/css/components/delimiters.css"]
            },
            component__backgrounds_css: {
                css: ["/Content/css/components/backgrounds.css"]
            },
            component__backgrounds_js: {
                js: ["/Content/js/components/backgrounds.js"]
            },
            ...
            component__image_caption_css: {
                css: ["/Content/css/components/image-caption-parallax.css"]
            },
            component__image_caption: {
                dependency: ["component__image_caption_css", "assets__image_caption"]
            },
            component__tags: {
                css: ["/Content/css/components/tags.css"]
            },
            component__tags_js: {
                js: ["/Content/js/components/tags.js"]
            },
            component__timelines_css: {
                css: ["/Content/css/components/timelines.css"]
            },
            component__timelines: {
                dependency: ["component__timelines_css", "component__content_slider"]
            },
            component__timelines_js: {
                js: ["/Content/js/components/timelines.js"]
            },
            component__gallery_sliders_css: {
                css: ["/Content/css/components/gallery-sliders.css"]
            },
            component__gallery_sliders: {
                js: ["/Content/js/components/gallery-sliders.js"],
                dependency: ["slider__slick", "component__gallery_sliders_css"]
            },
            component__tables: {
                css: ["/Content/css/components/tables.css"],
                js: ["/Content/js/components/tables.js"]
            },
            component__shop_row: {
                css: ["/Content/css/components/shop-components-row.css"]
            },
            component__shop_tiles: {
                css: ["/Content/css/components/shop-components-tiles.css"],
                js: ["/Content/js/components/shop-components-tiles.js"],
                dependency: ["component__shop_row"]
            },
            component__shop_masonry: {
                css: ["/Content/css/components/shop-components-masonry.css"],
                dependency: ["component__shop_row"]
            },
            component__shop_grid_filter: {
                css: ["/Content/css/components/shop-components-grid-filter.css"],
                js: ["/Content/js/components/shop-components-grid-filter.js"],
                dependency: ["isotope"]
            },
            component__shop_honeycomb: {
                css: ["/Content/css/components/shop-components-honeycomb.css"]
            },
            ...
            component__shop_cards: {
                css: ["/Content/css/components/shop-components-cards.css"]
            },
            component__shop_flip: {
                css: ["/Content/css/components/shop-components-flip.css"],
                js: ["/Content/js/components/shop-components-flip.js"],
                dependency: ["scrollbar"]
            },
            component__shop_item_page: {
                css: ["/Content/css/components/shop-components-item-page.css"],
                js: ["/Content/js/components/shop-components-item-page.js"]
            },
            component__shop_item_page_sidebar: {
                css: ["/Content/css/components/shop-components-item-sidebar.css"]
            },
            component__elements: {
                css: ["/Content/css/components/elements.css"]
            },
            component__header: {
                css: ["/Content/css/assets/brk-header-elements.css"],
                js: ["/Content/js/assets/brk-header.js"]
            },
            component__footer: {
                css: ["/Content/css/components/footer.css"],
                js: ["/Content/js/components/footer.js"]
            },
            component__svg_pattern: {
                css: ["/Content/css/components/svg-pattern.css"]
            },
            component__gallery: {
                css: ["/Content/css/components/gallery-cols.css"],
                dependency: ["fancybox"]
            },
            component__image_map: {
                css: ["/Content/css/assets/image-map-pro.css", "Content/css/components/image-map.css"],
                js: ["/Content/js/assets/image-map-pro.min.js", "Content/js/components/image-map.js"],
                dependency: ["component__title"]
            },
            component__parallax: {
                css: ["/Content/css/components/parallax.css"],
                js: ["/Content/vendor/paraxify/js/paraxify.min.js", "Content/js/components/parallax.js"],
                dependency: ["waypoints"]
            },
            "component__parallax-video": {
                dependency: ["component__parallax"],
                css: ["/Content/css/components/parallax-video.css"],
                js: ["vendor/jqueryMbYT_player/js/jquery.mb.YTPlayer.min.js", "vendor/jqueryMbVimeo_player/js/jquery.mb.vimeo_player.min.js", "/Content/js/components/parallax-video.js"]
            },
            component__checkout: {
                css: ["/Content/css/components/checkout.css"],
                js: ["/Content/js/components/checkout.js"]
            }
        };
        //try {
        ...
        window.addEventListener("load", function () {
            a("html").addClass("brk-preloader-remove"), setTimeout(function () {
                a("html").removeClass("brk-preloader brk-preloader-remove")
            }, 1500)
        }), setTimeout(function () {
            a("html").addClass("brk-preloader-remove"), setTimeout(function () {
                a("html").removeClass("brk-preloader brk-preloader-remove")
            }, 1500)
        }, 5e3), d && (a("head").append('<link rel="stylesheet" href="~Content/css/assets/novi.css">'), window.addEventListener("load", function () {
            var e = a(".brk-css-add"),
    ...
    function (o) {
        var t = o(".brk-theme-options"),
            n = t.find(".panel-open"),
            e = t.find(".panel-close");
        n.on("click", function (e) {
            e.preventDefault(), o(this).toggleClass("checked"), t.toggleClass("active")
        }), e.on("click", function () {
        ...
        //var r = o(".brk-theme-options__color").find(".brk-theme-options__color-radio"),
        //    s = o("#brk-skin-color"),
        //    a = o("html").data("brk-skin");
        //r.each(function() {
        //    var e = o(this),
        //        t = e.data("skin");
        //    a.indexOf(t) + 1 && e.addClass("checked"), e.on("click", function() {
        //        s.attr("href", "Content/css/skins/" + t + ".css"), r.removeClass("checked"), e.addClass("checked"), o("html").data("brk-skin", t + ".css")
        //    })
        //});
        var l = o("[data-brk-direction]"),
            c = l.find(".brk-theme-options__check"),
            d = o("#brk-direction-bootstrap"),
            u = o("#brk-direction-offsets");
        l.each(function () {
            var e = o(this),
                t = e.data("brk-direction"),
                n = e.find(".brk-theme-options__check");
            e.on("click", function (e) {
                e.preventDefault(), o("html").attr("dir", t), "rtl" === t ? (d.attr("href", "~/Content/css/assets/bootstrap-rtl.css"), u.attr("href", "Content/css/assets/offsets-rtl.css")) : (d.attr("href", "css/assets/bootstrap.css"), u.attr("href", "Content/css/assets/offsets.css")), c.removeClass("brk-theme-options__check_active"), n.addClass("brk-theme-options__check_active"), setTimeout(function () {
                    locationScreen()
                }, 500)
            })
        });
        var f = o("[data-brk-options-border]"),
            p = f.find(".brk-theme-options__check");
        f.each(function () {
            var n = o(this),
            ...
            n.on("click", function (e) {
                ...
                p.removeClass("brk-theme-options__check_active"), i.addClass("brk-theme-options__check_active"), 0 !== t ? o("body").addClass("brk-bordered-theme").attr("data-border", t) : o("body").removeClass("brk-bordered-theme").removeAttr("data-border"), Berserk.behaviors.border_theme_init.attach(o(document))
            })
        });
        var h = o("[data-brk-layout]"),
            m = h.find(".brk-theme-options__check");
        h.each(function () {
            var n = o(this),
                i = n.find(".brk-theme-options__check");
            n.on("click", function (e) {
                ...
                m.removeClass("brk-theme-options__check_active"), i.addClass("brk-theme-options__check_active"), "boxed" === t ? o("body").addClass("brk-boxed") : o("body").removeClass("brk-boxed")
            })
        });
        var g = o(".brk-theme-options-pathname"),
            v = window.location.pathname.replace(/\//g, "");
        g.each(function () {
            var e = o(this),
                t = e.attr("href").replace(/\//g, ""),
                n = e.find(".brk-theme-options__check");
            t === v && n.addClass("brk-theme-options__check_active")
        })
    }(jQuery),
    function (k) {
        Berserk.behaviors.header_init = {
            attach: function (e, t) {
                k(e).parent().find(".brk-header:not(.rendered)").addClass("rendered").each(function () {
                    var d = k(this),
                        i = d.find(".brk-header__main-bar"),
                        o = i.data("height-scroll"),
                        n = d.data("sticky-hide");
                    k("body").width();
                    d.hasClass("brk-header_not-fixed") && (992 < (b = window.innerWidth || k(window).width()) && k("body").css("padding-top", i.height()));
                    if (k(".brk-header__top-bar").length) {
                        var r = d.find(".brk-header__top-bar_hide"),
                            s = d.find(".brk-header__top-bar_scroll"),
                            a = d.find(".brk-header__top-bar").data("top");

                        function e(e) {
                            if (e <= (window.innerWidth || k(window).width())) {
                                if (r.length) {
                                    var t = r.innerHeight() - a;
                                    d.css("top", "-" + t + "px")
                                }
                            } else d.css("top", "0")
                        }
                        ...
                        function t(e) {
                            if (1 !== n)
                                if (e <= (window.innerWidth || k(window).width())) {
                                    if (s.length) {
                                        var t = s.innerHeight() - a;
                                        0 < k(this).scrollTop() ? d.css("top", "-" + t + "px") : k(this).scrollTop() <= 0 && d.css("top", "0")
                                    }
                                } else d.css("top", "0")
                        }
                        a = a || 0, setTimeout(function () {
                            e(992)
                        }, 2e3), t(992), k(window).on("resize scroll", function () {
                            e(992), t(992)
                        })
                    }

                    function l(e) {
                        var t = window.innerWidth || k(window).width();
                        if (o) var n = i.data("height-temp");
                        e <= t && (0 < k(this).scrollTop() ? (d.addClass("brk-header_scroll"), o && i.css("height", o + "px")) : k(this).scrollTop() <= 0 && (d.removeClass("brk-header_scroll"), o && i.css("height", n + "px"))), 0 < k(this).scrollTop() ? k(".brk-header-mobile").addClass("brk-header-mobile_scroll") : k(this).scrollTop() <= 0 && k(".brk-header-mobile").removeClass("brk-header-mobile_scroll")
                    }
                    if (o && i.data("height-temp", i.height()), l(992), k(window).scroll(function () {
                            l(992)
                    }), 1 === n) {
                        var c = 0;
                        setTimeout(function () {
                            k(window).scroll(function () {
                                var e = k(this).scrollTop(),
                                    t = !1,
                                    n = !1;
                                0 < e && (c < e ? (t = !1, e < d.height() + d.offset().top && !1 === n && (d.addClass("brk-header_sticky-hide"), n = !0)) : (n = !1, e > d.offset().top && !1 === t && (d.removeClass("brk-header_sticky-hide"), t = !0)), c = e)
                            })
                        }, 2500)
                    }
                    var u = !1;
                    ...
                    function f(e) {
                        ...
                        if (t < e && !u) {
                            ...
                            var n = k(".brk-header-mobile-wrap"),
                                i = k(".brk-header-mobile-wrap__body"),
                                o = d.data("logo-src"),
                                r = d.data("bg-mobile");
                            i.prepend('<div class="brk-before"></div><div class="brk-header-mobile-wrap__header"><div class="brk-header-mobile-wrap__close"><span></span></div></div>'), "" !== o && k(".brk-header-mobile-wrap__header").prepend('<div class="brk-header-mobile-wrap__logo"><a href="/"><img src="' + o + '" alt=""></a></div>'), "" !== r && n.css("background-image", "url(" + r + ")"), n.before('<div class="brk-header-mobile-wrap-layer"></div>'), u = !0
                        } else e <= t && u && (k(".brk-header-mobile-wrap__header").detach(), k(".brk-header-mobile-wrap-layer").remove(), k(".brk-before, .brk-header-mobile-wrap__header").remove(), d.unwrap(), d.unwrap(), u = !1);
                        var s = k(".brk-header-mobile"),
                            a = s.find(".brk-header-mobile__open"),
                            l = (n = k(".brk-header-mobile-wrap")).find(".brk-header-mobile-wrap__close"),
                            c = k(".brk-header-mobile-wrap-layer");
                        s.length && a.click(function () {
                            k("body").addClass("modal-open"), n.addClass("is-active"), c.addClass("is-active")
                        }), n.length && l.click(function () {
                            k("body").removeClass("modal-open"), n.removeClass("is-active"), c.removeClass("is-active")
                        })
                    }
                    f(992), k(window).resize(function () {
                        f(992)
                    });
                    var p = !1;
                    ...
                    function h(e) {
                        var t = k(".brk-nav"),
                            ...
                            i = n.children("a"),
                            o = t.find("a"),
                            r = window.innerWidth || k(window).width();
                        if (r < e && !p) {
                            if (n.prepend('<div class="brk-nav__link-open"><i class="fa fa-angle-right"></i></div>'), k(".brk-nav__link-open").length) {
                                var s = k(".brk-nav__link-open");

                                function a() {
                                    n.each(function () {
                                        var e = k(this),
                                            t = e.find(".brk-nav__link-open"),
                                            n = e.find("a").outerHeight();
                                        t.css("height", n)
                                    })
                                }
                                a(), 0 < s.length && s.on("click", function () {
                                    var e = k(this),
                                        t = e.parent(),
                                        n = t.children(".brk-nav-drop-down");
                                    t.toggleClass("children-active"), e.toggleClass("is-active"), n.slideToggle(400), a()
                                }), i.each(function () {
                                    var e = k(this),
                                        t = e.attr("href");
                                    "#" !== t && "" !== t || e.on("click", function (e) {
                                        e.preventDefault();
                                        var t = k(this).parent(),
                                            n = t.children(".brk-nav-drop-down"),
                                            i = t.children(".brk-nav__link-open");
                                        t.toggleClass("children-active"), i.toggleClass("is-active"), n.slideToggle(400), a()
                                    })
                                })
                            }
                            o.each(function () {
                                var e = k(this);
                                !1 !== e.attr("href").indexOf("#") && e.on("click", function (e) {
                                    e.preventDefault();
                                    var t = k(this).parents(".brk-header-mobile-wrap");
                                    k("body").removeClass("modal-open"), t.removeClass("is-active"), k(".brk-header-mobile-wrap-layer").removeClass("is-active")
                                })
                            }), p = !0
                        } else 0 < k(".brk-nav__link-open").length && e <= r && p && (k(".brk-nav__link-open").remove(), n.removeClass("children-active"), p = !1)
                    }
                    k(document).ready(function () {
                        h(992)
                    }), k(window).resize(function () {
                        h(992)
                    }), k(".brk-nav__drop-down-effect").each(function () {
                        var e = k(this),
                            o = e.find(".dd-effect");
                        e.on("mouseenter", function () {
                            var e, t, n, i;
                            e = o, t = 10, i = "left" === n ? {
                                ...
                                opacity: 0,
                                left: -10
                            }, (e = "left" === n ? k(e.get().reverse()) : e).css(i).each(function (e) {
                                k(this).delay(t * e).animate({
                                    opacity: 1,
                                    left: 0
                                })
                            })
                        })
                    }), k(".brk-quantity").find(".brk-quantity__arrows").click(function () {
                        var e = k(this).parent().find(".brk-quantity__value"),
                            t = e.val();
                        k(this).hasClass("minus") && 1 < t ? e.val(+t - 1) : k(this).hasClass("plus") && e.val(+t + 1)
                    });
                    var m = k(".brk-info-menu"),
                        g = k(".brk-info-menu-open"),
                        v = m.find(".brk-info-menu__close"),
                        b = window.innerWidth || k(window).width();

                    function y(e, t, n, i) {
                        t = (e = k(e)).find(t), n = e.find(n);
                        var o = window.innerWidth || k(window).width();
                    ...
                    function _(e) {
                        var t = window.innerWidth || k(window).width();
                        t < e ? k(".brk-lang:not(.brk-lang-rendered)").addClass("brk-lang-rendered").each(function () {
                            var e = k(this),
                        ...
                        }).removeClass("brk-lang_interactive-rendered") : e <= t && (k(".brk-lang_interactive:not(.brk-lang_interactive-rendered)").addClass("brk-lang_interactive-rendered").each(function () {
                            var e = k(this),
                            ...
                            t.css({
                                ...
                                i.css("opacity", "0"), n.css("background", "transparent !important"), t.addClass("top-bar-bg"), k("div").is(".brk-overlay") || k("body").append('<div class="brk-overlay"></div>'), o.css("border", "0")
                            }), e.on("mouseout", function () {
                                i.css("opacity", "1"), n.removeAttr("style"), t.removeClass("top-bar-bg"), k("div").is(".brk-overlay") && k(".brk-overlay").remove(), o.css("border", "")
                            })
                        }).removeClass("brk-lang-rendered"), k(".brk-lang__option").css("display", ""), k(".brk-lang").find(".brk-lang__open").unbind("click"))
                    }

                    function w() {
                        var n = window.innerWidth || k(window).width();
                        k(".brk-mini-cart, .brk-social-links, .brk-search, .brk-lang, .brk-nav__sub-menu").each(function () {
                            var e = k(this),
                                t = n / 2;
                            e.offset().left < t ? e.removeClass("brk-location-screen-left brk-location-screen-right").addClass("brk-location-screen-left") : e.removeClass("brk-location-screen-left brk-location-screen-right").addClass("brk-location-screen-right")
                        })
                    }
                    g.on("click", function () {
                        m.toggleClass("active"), g.toggleClass("open-active"), 992 <= b && k("body").toggleClass("modal-open")
                    }), v.on("click", function () {
                        m.hasClass("active") && m.removeClass("active"), g.hasClass("open-active") && g.removeClass("open-active"), 992 <= b && k("body").hasClass("modal-open") && k("body").removeClass("modal-open")
                    }), k(document).on("click", function (e) {
                        k(e.target).closest(".brk-info-menu").length || k(e.target).closest(".brk-info-menu-open").length || (m.hasClass("active") && m.removeClass("active"), g.hasClass("open-active") && g.removeClass("open-active"), 992 <= b && k("body").hasClass("modal-open") && k("body").removeClass("modal-open")), e.stopPropagation()
                    }), y(".brk-mini-cart", ".brk-mini-cart__open, .brk-mini-cart__info-open", ".brk-mini-cart__menu", 992), y(".brk-social-links", ".brk-social-links__open", ".brk-social-links__block", 992), y(".brk-search", ".brk-search__open", ".brk-search__block", 992), k(window).resize(function () {
                        y(".brk-mini-cart", ".brk-mini-cart__open, .brk-mini-cart__info-open", ".brk-mini-cart__menu", 992), y(".brk-social-links", ".brk-social-links__open", ".brk-social-links__block", 992), y(".brk-search", ".brk-search__open", ".brk-search__block", 992)
                    }), 992 <= (window.innerWidth || k(window).width()) && k(".brk-search_interactive").each(function () {
                        var e = k(this),
                        ...
                        i.on("click", function () {
                            r.addClass("active"), n.addClass("position-relative"), a.hide(0), k(this).hide(0), k("div").is(".brk-overlay") || k("body").append('<div class="brk-overlay"></div>'), setTimeout(function () {
                                s.focus()
                            }, 150), l.css("border", "0")
                        }), o.on("click", function () {
                            r.removeClass("active"), a.show(0), i.show(0), n.removeClass("position-relative"), k("div").is(".brk-overlay") && k(".brk-overlay").remove(), l.css("border", "")
                        }), k(document).on("click", function (e) {
                            k(e.target).closest(".brk-header").length || (r.removeClass("active"), a.show(0), i.show(0), n.removeClass("position-relative"), k("div").is(".brk-overlay") && k(".brk-overlay").remove(), l.css("border", "")), e.stopPropagation()
                        })
                    }), k(document).ready(function () {
                        _(992)
                    }), k(window).resize(function () {
                        ...
                        function () {
                            if (0 < k(".brk-header-popup-menu").length) {
                                k("body").append('<div class="brk-header-popup-menu-layer"></div>');
                                var t = k(".brk-header-popup-menu").find(".brk-header-popup-menu__open-close"),
                                    n = k(".brk-header-popup-menu__menu"),
                                    e = k(".brk-header-popup-menu-layer");
                                0 < k(".brk-header_vertical").length && (k(".brk-header").append(n), n.addClass("brk-moved-by-js")), t.click(function () {
                                    k(this).toggleClass("is-active"), n.fadeToggle(300), e.fadeToggle(500)
                                }), e.click(function () {
                                    var e = k(this);
                                    t.toggleClass("is-active"), n.fadeToggle(300), e.fadeToggle(500)
                                })
                            }
                        }(), k(".brk-totop").on("click", function () {
    ...
    function (p) {
        ...
        Berserk.behaviors.tabs_init = {
            attach: function (e, t) {
                ...
                p(".brk-tabs:not(.rendered)", e).addClass("rendered").each(function () {
                    if (p(this).hasClass("brk-tabs-hovers")) {
                        var e = (l = p(this)).find(".brk-tabs-nav"),
                            n = (r = l.find(".brk-tab"), s = l.find(".brk-tab-item"), a = l.data("index"), l.closest(".brk-header_style-1")),
                            t = l.closest(".brk-header_style-2");
                        if (a = a || 0, n[0] ? l.addClass("brk-tabs-hovers_style-1") : t[0] && l.addClass("brk-tabs-hovers_style-2"), n[0] && e.append('<div class="brk-tabs-hovers__duplicate-icon"></div>'), p(document).ready(function () {
                                s.hide().eq(a).fadeIn(), r.eq(a).addClass("current")
                        }), n[0]) {
                            var i = l.find(".current").children('[class*="fa-"]'),
                                o = e.find(".brk-tabs-hovers__duplicate-icon");
                            i.clone().appendTo(o)
                        }
                        r.on("mouseenter", function () {
                            var e = p(this),
                                t = e.children('[class*="fa-"]');
                            n[0] && (o.empty(), t.clone().appendTo(o)), e.hasClass("current") || (r.removeClass("current").eq(p(this).index()).addClass("current"), s.hide().eq(p(this).index()).fadeIn())
                        })
                    } else {
                        var r = (l = p(this)).find(".brk-tab"),
                            s = l.find(".brk-tab-item"),
                            a = l.data("index");
                        l.data("hash"), window.location.hash;
                        a = a || 0, p(document).ready(function () {
                            s.hide().eq(a).fadeIn()
                        }), r.on("click", function () {
                            p(this).addClass("active").siblings(".active").removeClass("active no-hover"), s.hide().eq(p(this).index()).fadeIn();
                            var e = s.eq(p(this).index()).find(".slick-slider");
                            e.length && e.each(function () {
                                var e, t = p(this);
                    ...
                    if (p(this).hasClass("brk-tabs-simple-top") || p(this).hasClass("brk-tabs-simple-bottom") || p(this).hasClass("brk-tabs-bottom-top") || p(this).hasClass("brk-tabs-bottom-bottom") || p(this).hasClass("brk-tabs-parallax") || p(this).hasClass("brk-tabs_tabbed-filter")) {
                        var l, c = (l = p(this)).find(".brk-tabs-nav"),
                            d = (r = l.find(".brk-tab"), l.find(".brk-tab.active"));
                        c.append("<span class='magic-line'></span>");
                        var u = l.find(".magic-line");
                        p(document).ready(function () {
                            ...
                            if (r.hasClass("active")) {
                                var e = l.find(".brk-tab.active");
                                u.width(e.innerWidth()).css("left", e.position().left).data("origLeft", u.position().left).data("origWidth", u.innerWidth())
                            }
                        }), r.hover(function () {
                            var e = p(this),
                                t = e.position().left,
                            ...
                            var i = l.find(".brk-tab.active");
                            !1 === e.hasClass("active") && i.addClass("no-hover")
                        }, function () {
                            u.stop().animate({
                                left: u.data("origLeft"),
                                width: u.data("origWidth")
                            }), l.find(".brk-tab.active").removeClass("no-hover")
                        })
                    }
                })
            }
            ...
            attach: function (e, t) {
                if (p(".brk-slider:not(.rendered)").length) {
                    if (void 0 === p.fn.slick) return console.log("Waiting for the slick library"), void setTimeout(Berserk.behaviors.tabs_slider_init.attach, t.timeout_delay, e, t);
                    p(e).parent().find(".brk-slider:not(.rendered)").addClass("rendered").each(function () {
                        var e = p(this),
                            t = e.find(".brk-slider__items"),
                            r = p(this).find(".brk-slider__prev"),
                            s = p(this).find(".brk-slider__next");
                        t.on("init", function (e, t, n, i) {
                            ...
                            appendDots: e.find(".brk-slider__control"),
                            responsive: [{
                                breakpoint: 1024,
                                settings: {
                                    slidesToShow: 2,
    ...
    function (o) {
        Berserk.behaviors.buttons_js = {
            attach: function (e, t) {
                window.addEventListener("load", function () {
                    var t;
                    o(".btn__dropdown_wrap").each(function () {
                        o(this).hasClass("open") ? (t = 0, o(this).children().each(function () {
                            t += o(this).outerHeight()
                        }), o(this).css({
                            height: t
                        })) : o(this).css({
                            height: o(this).children("li:first-child").innerHeight()
                        })
                    }), o(".btn__dropdown_wrap").on("click", function (e) {
                        e.target === this && (t = 0, o(this).children().each(function () {
                            t += o(this).outerHeight()
                        }), o(this).toggleClass("open"), o(this).hasClass("open") ? o(this).css({
                            height: t
                        }) : o(this).css({
                            height: o(this).children("li:first-child").innerHeight()
                        }))
                    })
                }), o(".btn-pos").on("mouseenter", function (e) {
                    var t = o(this).offset(),
                        n = e.pageX - t.left,
                        i = e.pageY - t.top;
                ...
                }), o(".slide-bg-wrap").on("mouseenter", function (e) {
                    var t = o(this).offset(),
                        n = e.pageX - t.left,
                        i = e.pageY - t.top;
                    o(this).find(".slide-bg").css({
                        top: i,
                        left: n
                    })
                }).on("mouseout", function (e) {
                ...
                }), o(".btn-gradient").on("mousemove", function (e) {
                    var t = o(this).offset(),
                        n = e.pageX - t.left,
                        i = e.pageY - t.top;
                    o(this).css({
    ...
    function (o) {
        ...
        o.fn.berserkforms = function (e) {
            options = o.extend({}, t, e);
            var i = 0;
            return this.each(function () {
                var e = o(this),
                    t = null,
                    n = null;
                o(this).addClass("rendered"), t = null != e.attr("placeholder") && e.attr("placeholder"), e.removeAttr("placeholder"), null != e.attr("id") ? n = e.attr("id") : (n = "brkin-" + i, e.attr("id", n)), e.wrap(function () {
                    return '<div class="' + options.formWrap + '"></div>'
                }), null == e.attr("readonly") && 0 != t && e.parent().append('<label class="' + options.inputLabel + '" for="' + n + '">' + t + "</label>"), "" != e.val() && null == e.attr("readonly") && e.parent().addClass(options.formWrapActive), e.focus(function () {
                    null == e.attr("readonly") && e.parent().addClass(options.formWrapActive)
                }), e.blur(function () {
                    "" == e.val() && e.parent().removeClass(options.formWrapActive)
                }), i++
            }), this
        }
    }(jQuery),
    function (i) {
        Berserk.behaviors.form_controls = {
            attach: function (e, t) {
                var n;
                if (i('.brk-form-strict [type="text"]:not(.rendered), .brk-form-strict [type="search"]:not(.rendered), .brk-form-strict [type="password"]:not(.rendered), .brk-form-strict [type="email"]:not(.rendered), .brk-form-strict [type="tel"]:not(.rendered), .brk-form-strict textarea:not(.rendered)').berserkforms(), void 0 === i.fn.styler) return console.log("Waiting for the styler library"), void setTimeout(Berserk.behaviors.form_controls.attach, t.timeout_delay, e, t);
                i(e).parent().find("select:not(.rendered)").styler(), (n = i(e).parent().find('[type="date"]:not(.rendered)')).each(function () {
                    var e = i(this);
                    i(this).addClass("rendered"), e.wrap(function () {
                        return '<div class="brk-form-date-wrap"></div>'
                    })
                }), n.parent().append('<span class="icon-before"><i class="fa fa-calendar" aria-hidden="true"></i></span>'), i(e).parent().find('.brk-form [type="file"]:not(.rendered)').each(function () {
                    var n = i(this),
                        e = "brk-form-file-wrap";
                    i(this).addClass("rendered"), "file" == n.attr("type") && (n.parents().hasClass("brk-form-strict") ? (n.wrap(function () {
                ...
                }), i("body").find('.brk-form [type="checkbox"]:not(.rendered)').each(function () {
                    var e = i(this);
                    i(this).addClass("rendered"), "checkbox" == e.attr("type") && (e.wrap(function () {
                ...
                }), i(e).parent().find('.brk-form [type="radio"]:not(.rendered)').each(function () {
                    var e = i(this);
                    i(this).addClass("rendered"), "radio" == e.attr("type") && (e.wrap(function () {
                ...
                }), i(".brk-subscribe-mail:not(.rendered)").addClass("rendered").each(function () {
                    var n = i(this);
                    n.on("submit", function (e) {
                        e.preventDefault();
                        var t = i(this).serialize();
                        i.getJSON("php/subscribe.php", t, function (e) {
                            var t = "<span class='brk-subscribe-message font__family-open-sans font__size-14 line__height-21 opacity-80'>" + ("subscribed" === e.status ? "Thanks for subscribing!" : "Something goes wrong :(") + "</span>";
                            n.append(t), setTimeout(function () {
                                n.find(".brk-subscribe-message").fadeOut()
                            }, 3e3)
                        })
                    })
                }), i("input,textarea").focus(function () {
                    i(this).data("placeholder", i(this).attr("placeholder")), i(this).attr("placeholder", "")
                }), i("input,textarea").blur(function () {
                    i(this).attr("placeholder", i(this).data("placeholder"))
                })
            }
        }
    }(jQuery),
            ...
            attach: function (e, t) {
                ...
                a(".fb-video:not(.rendered)", e).addClass("rendered").length && (n = document, i = "script", o = "facebook-jssdk", s = n.getElementsByTagName(i)[0], n.getElementById(o) || ((r = n.createElement(i)).id = o, r.src = "https://connect.facebook.net/uk_UA/sdk.js#xfbml=1&version=v2.11", s.parentNode.insertBefore(r, s))), a(".brk-hosted-video:not(.rendered)", e).addClass("rendered").each(function (e) {
                    var t = a(this).find(".brk-hosted-video__btn"),
                        n = a(this).find("video"),
                        i = a(this).find("source"),
                        o = i.attr("data-src");
                    a(this).find(".brk-hosted-video__img");
                    a(this).hasClass("brk-hosted-video_inner") || (t.attr("href", "#brk-hosted-video-" + e), n.attr("id", "brk-hosted-video-" + e), t.click(function (e) {
                        i.attr("src", o), setTimeout(function () {
                            n.get(0).play()
                        }, 100)
                    })), a(this).hasClass("brk-hosted-video_inner") && t.click(function (e) {
                        n.css("display", "block"), t.css("display", "none"), i.attr("src", o), setTimeout(function () {
                            n.get(0).play()
                        }, 100)
                    })
                })
            ...
            attach: function (e, t) {
                if (r(".brk-footer__wrapper:not(.rendered)", e).each(function () {
                        if (r(this).hasClass("brk-footer__wrapper_animated")) {
                            ...
                            function o() {
                                t.css("height", e.outerHeight(!0)).addClass("brk-footer_animated"), n.css("margin-bottom", e.outerHeight(!0)).css("background-color", "#fff").css("z-index", "2")
                }
                            i >= e.outerHeight(!0) && o(), r(this).bind("DOMSubtreeModified", function () {
            ...
            attach: function (e, t) {
                if (!(c(".brk-grid:not(.rendered):not(.brk-grid-sorted)").length < 1)) {
                    ...
                    n.length && n.each(function () {
                        ...
                        r.attr("data-grid-cols-tablet") && (t = r.attr("data-grid-cols-tablet")), l(a), c(window).resize(function () {
                            l(c(window).width())
                        }), setTimeout(function () {
                            o = r.isotope({
                            ...
                            var e = c(this),
                                t = c(this).attr("data-filter");
                            if (t && "*" !== t) {
                                var n = r.find(t).length;
                                e.find(".brk-filters__count").html(n)
                            }
                            if (t && "*" === t) {
                                n = r.find(".brk-grid__item").length;
                                e.find(".brk-filters__count").html(n)
                            }
            ...
            attach: function (e, t) {
                if (!(l(".brk-grid-fitrows:not(.rendered), .brk-simple-card-2:not(.rendered)").length < 1)) {
                    ...
                    a.each(function () {
                        ...
                        a.attr("data-grid-cols-tablet") && (t = a.attr("data-grid-cols-tablet")), s(e), l(window).resize(function () {
                            s(l(window).width())
    ...
    function (o) {
        Berserk.behaviors.parallax_video_init = {
            attach: function (e, t) {
                var n;
                o(".vimeo-video:not(.rendered), .player-yt:not(.rendered), .player-vimeo:not(.rendered)").length < 1 || (n = [], o(".vimeo-video:not(.rendered) iframe").each(function () {
                    n[i] = new Vimeo.Player(this), n[i].setVolume(0)
                }), o(".vimeo-video").addClass("rendered"), o(function () {
    ...
    function (n) {
        Berserk.behaviors.sliders_page_init = {
            attach: function (e, t) {
                if (!(n(".brk-carousel_project:not(.rendered)").length < 1)) return void 0 === n.fn.slick ? (console.log("Waiting for the slick library"), void setTimeout(Berserk.behaviors.slick_init.attach, t.timeout_delay, e, t)) : void n(e).parent().find(".brk-carousel_project:not(.rendered)").addClass("rendered").each(function () {
                    var e = n(this),
        ...
        Berserk.behaviors.ranged_slider_init = {
            attach: function (e, t) {
                if (!(i("#slider").length < 1)) {
                    ...
                    }), i("input.sliderValue").change(function () {
                        var e = i(this);
                        i("#slider").slider("values", e.data("index"), e.val())
                    }), i("button#filter-trigger").on("click", function () {
                        this.classList.toggle("closed"), this.nextElementSibling.classList.toggle("closed")
    ...
    function (d) {
        Berserk.behaviors.info_box_init = {
            attach: function (e, t) {
                ...
                n.length && n.each(function () {
                    var e = d(this),
                        t = 1e3 * e.data("wh-delay");
                    if (isNaN(parseFloat(t))) n = 1e3;
                    else var n = t;
                    var i = 1e3 * e.data("wh-speed");
                    if (isNaN(parseFloat(i))) o = 1e3;
                    else var o = i;
                    var r = e.data("wh-repeat"),
                        s = e.find(".wpb_column"),
                        a = s.length,
                        l = 0;
    ...
    function (n) {
        Berserk.behaviors.blog__page_init = {
            attach: function (e, t) {
                if (!(n(".brk-related-carousel:not(.rendered)").length < 1)) {
                    if (void 0 === n.fn.slick) return console.log("Waiting for the slick library"), void setTimeout(Berserk.behaviors.blog__page_init.attach, t.timeout_delay, e, t);
                    n(e).parent().find(".brk-related-carousel:not(.rendered)").each(function () {
                        var e = n(this).find(".brk-related-carousel__items");
                        e.on("init afterChange", function (e, t) {
                            t.$dots.removeClass("slick-dots"), t.$dots.addClass("brk-related-carousel__dots")
                        }), e.slick({
                            dots: !0,
                            prevArrow: !1,
                            nextArrow: !1,
